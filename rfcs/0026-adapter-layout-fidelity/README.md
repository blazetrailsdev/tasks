...
| [extract-pg-schema-statements-alter-table](stories/extract-pg-schema-statements-alter-table.md)                                       | Extract PG alter-table statements into PostgreSQLSchemaStatements                          | claimed | 450     | adapter-layout |
