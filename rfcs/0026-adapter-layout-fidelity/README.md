...
| ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ----------- | ------- | -------------- |
| [converge-pg-alter-table-clear-cache](stories/converge-pg-alter-table-clear-cache.md)                                                 | Converge PG alter-table methods to Rails (clear_cache!, validation, single-ALTER)          | draft       | 120     | adapter-layout |
...
| [pg-indexes-rails-fidelity](stories/pg-indexes-rails-fidelity.md)                                                                     | Close PG indexes() / addIndex / renameIndex Rails-fidelity gaps                            | ready       | 120     | adapter-layout |
...
| [extract-pg-schema-statements-alter-table](stories/extract-pg-schema-statements-alter-table.md)                                       | Extract PG alter-table statements into PostgreSQLSchemaStatements                          | in-progress | 450     | adapter-layout |
