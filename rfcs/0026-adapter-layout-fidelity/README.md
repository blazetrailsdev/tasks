...
| --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------- | ------- | -------------- |
| [sqlite-uri-resolver-dedup-node-libsql](stories/sqlite-uri-resolver-dedup-node-libsql.md)                                                     | Dedup identical URI-aware resolveDatabasePath across node-sqlite and libsql drivers                  | claimed | 40      | —              |
