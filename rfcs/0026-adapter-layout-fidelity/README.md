...
| --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------- | ------- | -------------- |
| [extract-pg-schema-statements-sequences-primary-keys](stories/extract-pg-schema-statements-sequences-primary-keys.md)                         | Extract PG sequence/primary-key statements into PostgreSQLSchemaStatements                           | ready       | 300     | —              |
