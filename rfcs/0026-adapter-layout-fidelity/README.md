...
| --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------- | ------- | -------------- |
| [extract-pg-schema-statements-tables-introspection-remainder](stories/extract-pg-schema-statements-tables-introspection-remainder.md)         | Extract remaining PG table/introspection statements into PostgreSQLSchemaStatements                  | ready       | 300     | —              |
