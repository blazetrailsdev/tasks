...
| [pg-dropschema-cascade-and-searchpath-memoization-fidelity](stories/pg-dropschema-cascade-and-searchpath-memoization-fidelity.md)     | pg-dropschema-cascade-and-searchpath-memoization-fidelity                                  | claimed     | null    | —              |
| [pg-indexes-rails-fidelity](stories/pg-indexes-rails-fidelity.md)                                                                     | Close PG indexes() / addIndex / renameIndex Rails-fidelity gaps                            | claimed     | 120     | adapter-layout |
