...
| --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------- | ------- | -------------- |
| [extract-pg-referential-integrity](stories/extract-pg-referential-integrity.md)                                                               | Extract PG disableReferentialIntegrity into its referential-integrity module                         | ready       | 120     | adapter-layout |
