...
| --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------- | ------- | -------------- |
| [extract-pg-schema-statements-unique-constraints](stories/extract-pg-schema-statements-unique-constraints.md)                                 | Extract PG unique-constraint statements into PostgreSQLSchemaStatements                              | ready       | 250     | —              |
| [extract-pg-schema-statements-sequences-primary-keys](stories/extract-pg-schema-statements-sequences-primary-keys.md)                         | Extract PG sequence/primary-key statements into PostgreSQLSchemaStatements                           | claimed     | 300     | —              |
| [extract-pg-schema-statements-tables-introspection-remainder](stories/extract-pg-schema-statements-tables-introspection-remainder.md)         | Extract remaining PG table/introspection statements into PostgreSQLSchemaStatements                  | claimed     | 300     | —              |
| [converge-pg-build-change-column-definition-via-table-definition](stories/converge-pg-build-change-column-definition-via-table-definition.md) | Converge PG buildChangeColumnDefinition to route through createTableDefinition().newColumnDefinition | in-progress | 80      | —              |
| [extract-pg-referential-integrity](stories/extract-pg-referential-integrity.md)                                                               | Extract PG disableReferentialIntegrity into its referential-integrity module                         | in-progress | 120     | adapter-layout |
