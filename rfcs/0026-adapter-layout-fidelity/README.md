...
| [converge-pg-alter-table-clear-cache](stories/converge-pg-alter-table-clear-cache.md)                                                 | Converge PG alter-table methods to Rails (clear_cache!, validation, single-ALTER)          | claimed     | 120     | adapter-layout |
