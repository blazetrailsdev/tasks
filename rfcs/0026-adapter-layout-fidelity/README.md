...
| [pg-indexes-rails-fidelity](stories/pg-indexes-rails-fidelity.md)                                                                     | Close PG indexes() / addIndex / renameIndex Rails-fidelity gaps                            | draft       | 120     | adapter-layout |
| [extract-pg-schema-statements-alter-table](stories/extract-pg-schema-statements-alter-table.md)                                       | Extract PG alter-table statements into PostgreSQLSchemaStatements                          | ready       | 450     | adapter-layout |
| [extract-pg-schema-statements-constraints](stories/extract-pg-schema-statements-constraints.md)                                       | Extract PG exclusion/unique-constraint statements into PostgreSQLSchemaStatements          | ready       | 420     | adapter-layout |
...
| [extract-pg-schema-statements-fks](stories/extract-pg-schema-statements-fks.md)                                                       | Extract PG foreign-key statements into PostgreSQLSchemaStatements                          | ready       | 480     | adapter-layout |
| [pg-dropschema-cascade-and-searchpath-memoization-fidelity](stories/pg-dropschema-cascade-and-searchpath-memoization-fidelity.md)     | pg-dropschema-cascade-and-searchpath-memoization-fidelity                                  | ready       | null    | —              |
...
| [extract-pg-schema-statements-columns-types](stories/extract-pg-schema-statements-columns-types.md)                                   | Extract PG column introspection and typeToSql into PostgreSQLSchemaStatements              | in-progress | 480     | adapter-layout |
