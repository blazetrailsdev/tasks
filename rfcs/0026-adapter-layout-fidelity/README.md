...
| --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------- | ------- | -------------- |
| [extract-pg-referential-integrity](stories/extract-pg-referential-integrity.md)                                                               | extract-pg-referential-integrity                                                                     | ready       | 120     | adapter-layout |
| [extract-pg-schema-statements-sequences-primary-keys](stories/extract-pg-schema-statements-sequences-primary-keys.md)                         | extract-pg-schema-statements-sequences-primary-keys                                                  | ready       | null    | —              |
| [extract-pg-schema-statements-tables-introspection-remainder](stories/extract-pg-schema-statements-tables-introspection-remainder.md)         | extract-pg-schema-statements-tables-introspection-remainder                                          | ready       | null    | —              |
| [extract-pg-schema-statements-unique-constraints](stories/extract-pg-schema-statements-unique-constraints.md)                                 | extract-pg-schema-statements-unique-constraints                                                      | ready       | null    | —              |
