...
| [extract-pg-schema-statements-sequences-primary-keys](stories/extract-pg-schema-statements-sequences-primary-keys.md)                         | Extract PG sequence/primary-key statements into PostgreSQLSchemaStatements                           | in-progress | 300     | —              |
| [extract-pg-schema-statements-tables-introspection-remainder](stories/extract-pg-schema-statements-tables-introspection-remainder.md)         | Extract remaining PG table/introspection statements into PostgreSQLSchemaStatements                  | in-progress | 300     | —              |
| [extract-pg-schema-statements-unique-constraints](stories/extract-pg-schema-statements-unique-constraints.md)                                 | Extract PG unique-constraint statements into PostgreSQLSchemaStatements                              | in-progress | 250     | —              |
