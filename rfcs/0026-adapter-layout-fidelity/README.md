...
| [extract-pg-schema-statements-columns-types](stories/extract-pg-schema-statements-columns-types.md)                                   | Extract PG column introspection and typeToSql into PostgreSQLSchemaStatements              | claimed | 480     | adapter-layout |
