...
| --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------- | ------- | -------------- |
| [converge-pg-build-change-column-definition-via-table-definition](stories/converge-pg-build-change-column-definition-via-table-definition.md) | Converge PG buildChangeColumnDefinition to route through createTableDefinition().newColumnDefinition | draft       | 80      | —              |
| [extract-pg-referential-integrity](stories/extract-pg-referential-integrity.md)                                                               | extract-pg-referential-integrity                                                                     | draft       | null    | —              |
| [extract-pg-schema-statements-sequences-primary-keys](stories/extract-pg-schema-statements-sequences-primary-keys.md)                         | extract-pg-schema-statements-sequences-primary-keys                                                  | draft       | null    | —              |
| [extract-pg-schema-statements-tables-introspection-remainder](stories/extract-pg-schema-statements-tables-introspection-remainder.md)         | extract-pg-schema-statements-tables-introspection-remainder                                          | draft       | null    | —              |
| [extract-pg-schema-statements-unique-constraints](stories/extract-pg-schema-statements-unique-constraints.md)                                 | extract-pg-schema-statements-unique-constraints                                                      | draft       | null    | —              |
...
| [extract-pg-schema-statements-enums-ranges-sequences](stories/extract-pg-schema-statements-enums-ranges-sequences.md)                         | Extract PG enum/range/sequence statements into PostgreSQLSchemaStatements                            | claimed     | 450     | adapter-layout |
| [pg-addindex-return-void-harmonize](stories/pg-addindex-return-void-harmonize.md)                                                             | Harmonize PG addIndex return type Promise<string> -> Promise<void>                                   | claimed     | 60      | adapter-layout |
| [converge-pg-alter-table-clear-cache](stories/converge-pg-alter-table-clear-cache.md)                                                         | Converge PG alter-table methods to Rails (clear_cache!, validation, single-ALTER)                    | in-progress | 120     | adapter-layout |
