...
| --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------- | ------- | -------------- |
| [sqlite-uri-resolver-dedup-node-libsql](stories/sqlite-uri-resolver-dedup-node-libsql.md)                                                     | Dedup identical URI-aware resolveDatabasePath across node-sqlite and libsql drivers                  | in-progress | 40      | —              |
...
| [mysql-rename-column-issue-real-ddl](stories/mysql-rename-column-issue-real-ddl.md)                                                           | mysql-rename-column-issue-real-ddl                                                                   | done        | null    | —              |
