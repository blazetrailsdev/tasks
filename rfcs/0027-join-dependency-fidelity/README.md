...
| [jd-reflections-include-through-intermediate-reflections](stories/jd-reflections-include-through-intermediate-reflections.md) | JoinDependency#reflections should include through-intermediate reflections (join_root.drop(1).map!(:reflection)) | claimed     | 50      | —               |
| [converge-joined-tables-memo-onto-regular-include-path](stories/converge-joined-tables-memo-onto-regular-include-path.md)     | Extend chain-tail @joined_tables memoization to the regular (non-through) include path                           | in-progress | 200     | —               |
