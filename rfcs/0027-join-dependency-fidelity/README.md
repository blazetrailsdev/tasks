...
| [fully-defer-construction-aliasing-via-emit-on-rebuild](stories/fully-defer-construction-aliasing-via-emit-on-rebuild.md)   | Fully defer within-dependency and through-path join aliasing to emit-time (rebuild ON at emit)         | claimed | 400     | —               |
