...
| --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | ----------- | ------- | --------------- |
| [converge-table-metadata-unconditional-where-hash-alias](stories/converge-table-metadata-unconditional-where-hash-alias.md) | Converge table-metadata associatedTable to Rails unconditional where-hash aliasing                     | ready       | 150     | —               |
| [converge-where-associated-missing-onto-join-dependency](stories/converge-where-associated-missing-onto-join-dependency.md) | Route whereAssociated/whereMissing through JoinDependency (retire flat \_resolve\*Join)                | ready       | 400     | —               |
| [defer-join-alias-assignment-to-emit-time](stories/defer-join-alias-assignment-to-emit-time.md)                             | Defer JoinDependency alias assignment to emit-time shared tracker                                      | ready       | 400     | —               |
| [self-join-alias-rebind-target-only](stories/self-join-alias-rebind-target-only.md)                                         | Self-join alias rebinding must alias only the target Table (not owner) for true self-associations      | ready       | 120     | —               |
| [unblock-where-references-association-name-aliasing](stories/unblock-where-references-association-name-aliasing.md)         | Unblock the where-references-association-name eager-load tests covering lazy make_constraints aliasing | ready       | 200     | —               |
| [belongs-to-join-association-name-alias](stories/belongs-to-join-association-name-alias.md)                                 | belongs-to-join-association-name-alias                                                                 | in-progress | null    | —               |
