...
| [join-part-table-name-delegate-to-base-klass](stories/join-part-table-name-delegate-to-base-klass.md)                         | Converge JoinPart#table_name to a base_klass delegate                                                            | done    | 120     | —               |
