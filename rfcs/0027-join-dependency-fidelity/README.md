...
| [fully-defer-construction-aliasing-via-emit-on-rebuild](stories/fully-defer-construction-aliasing-via-emit-on-rebuild.md)   | Fully defer within-dependency and through-path join aliasing to emit-time (rebuild ON at emit)         | ready       | 400     | —               |
...
| [defer-join-alias-assignment-to-emit-time](stories/defer-join-alias-assignment-to-emit-time.md)                             | Defer JoinDependency alias assignment to emit-time shared tracker                                      | in-progress | 400     | —               |
