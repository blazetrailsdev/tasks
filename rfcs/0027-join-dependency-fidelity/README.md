...
| [defer-join-alias-assignment-to-emit-time](stories/defer-join-alias-assignment-to-emit-time.md)                             | Defer JoinDependency alias assignment to emit-time shared tracker                                      | claimed     | 400     | —               |
| [converge-table-metadata-unconditional-where-hash-alias](stories/converge-table-metadata-unconditional-where-hash-alias.md) | Converge table-metadata associatedTable to Rails unconditional where-hash aliasing                     | in-progress | 150     | —               |
