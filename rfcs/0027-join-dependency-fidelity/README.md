...
| [converge-references-lazy-make-constraints](stories/converge-references-lazy-make-constraints.md)                     | Converge references consumption to Rails' lazy make_constraints aliasing                               | in-progress | 250     | join-dependency |
| [fold-named-inner-joins-into-build-join-dependencies](stories/fold-named-inner-joins-into-build-join-dependencies.md) | Fold plain .joins(:assoc) into buildJoinDependencies (drop \_joinClauses SQL pre-resolution)           | in-progress | 400     | —               |
