...
| [converge-joined-tables-memo-onto-regular-include-path](stories/converge-joined-tables-memo-onto-regular-include-path.md)     | Extend chain-tail @joined_tables memoization to the regular (non-through) include path                           | ready       | 200     | —               |
| [jd-reflections-include-through-intermediate-reflections](stories/jd-reflections-include-through-intermediate-reflections.md) | JoinDependency#reflections should include through-intermediate reflections (join_root.drop(1).map!(:reflection)) | ready       | 50      | —               |
| [join-part-table-name-delegate-to-base-klass](stories/join-part-table-name-delegate-to-base-klass.md)                         | Converge JoinPart#table_name to a base_klass delegate                                                            | ready       | 120     | —               |
...
| [emit-time-joined-tables-chain-tail-memoization](stories/emit-time-joined-tables-chain-tail-memoization.md)                   | emit-time-joined-tables-chain-tail-memoization                                                                   | in-progress | null    | —               |
