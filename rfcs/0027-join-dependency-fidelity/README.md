...
| --------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ------- | ------- | --------------- |
| [converge-references-lazy-make-constraints](stories/converge-references-lazy-make-constraints.md)                     | Converge references consumption to Rails' lazy make_constraints aliasing                      | draft   | 250     | join-dependency |
...
| [join-dependency-associations-map-key-consistency](stories/join-dependency-associations-map-key-consistency.md)       | Unify instantiateFromRows parent-key accessor (readAttribute vs \_readAttribute, raw vs cast) | ready   | 40      | —               |
...
| [construct-no-primary-key-join-primary-key-branch](stories/construct-no-primary-key-join-primary-key-branch.md)       | construct: handle no-primary-key nodes via join_primary_key (id=nil, skip caching)            | claimed | 60      | —               |
