...
| [converge-joined-tables-memo-onto-regular-include-path](stories/converge-joined-tables-memo-onto-regular-include-path.md)     | Extend chain-tail @joined_tables memoization to the regular (non-through) include path                           | claimed | 200     | —               |
