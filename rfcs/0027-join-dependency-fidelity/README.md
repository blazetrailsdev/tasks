...
| --------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ------- | ------- | --------------- |
| [fold-named-inner-joins-into-build-join-dependencies](stories/fold-named-inner-joins-into-build-join-dependencies.md) | Fold plain .joins(:assoc) into buildJoinDependencies (drop \_joinClauses SQL pre-resolution)  | ready   | 400     | —               |
