...
| --------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ------ | ------- | --------------- |
| [converge-references-lazy-make-constraints](stories/converge-references-lazy-make-constraints.md)                     | Converge references consumption to Rails' lazy make_constraints aliasing                      | ready  | 250     | join-dependency |
