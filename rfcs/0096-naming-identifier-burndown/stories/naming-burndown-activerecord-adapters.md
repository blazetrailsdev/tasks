---
title: "Rename locals/params to Rails' in activerecord connection adapters"
status: done
updated: 2026-08-11
...
Burn down the 71 `naming` call-argument rows in `packages/activerecord/src/connection-adapters/` — postgresql-adapter.ts (36), abstract/schema-statements.ts (27), abstract-adapter.ts (13), abstract-mysql-adapter.ts (12), sqlite3-adapter.ts (10).
