---
title: "Rename locals/params to Rails' in actionview and actioncontroller"
status: closed
updated: 2026-08-11
...
Burn down the 60 `naming` call-argument rows in `packages/actionview/src/` (31) and `packages/actionpack/src/actioncontroller/` (29).
