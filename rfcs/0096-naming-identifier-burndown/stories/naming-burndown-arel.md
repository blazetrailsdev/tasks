---
title: "Rename locals/params to Rails' in arel"
status: done
updated: 2026-08-11
...
Burn down the 109 `naming` call-argument rows in `packages/arel/src/` — visitors/to-sql.ts (28), select-manager.ts (14), attributes/attribute.ts (10), tail.
