...
| --------------------------------------------------------------- | ----: | ---: | ----: |
| `attribute_methods_test.rb`                                     |    77 |   99 |     1 |
| `attribute_methods/read_test.rb`                                |     1 |    2 |     0 |
| `attribute_methods/time_zone_converter_test.rb`                 |     0 |    1 |     0 |

**181 divergences** (78 assertion-count, 102 assertion-kind, 1
