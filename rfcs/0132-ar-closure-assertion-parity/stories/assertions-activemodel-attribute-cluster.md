...
The `Attribute` / `AttributeSet` / attribute-methods family.

| Rails file                       | count | kind | value |   total |
| -------------------------------- | ----: | ---: | ----: | ------: |
| `attribute_methods_test.rb`      |    15 |   18 |    10 |      43 |
| `attribute_test.rb`              |    13 |   22 |     6 |      41 |
| `attribute_set_test.rb`          |    13 |   22 |     4 |      39 |
| `attribute_registration_test.rb` |    10 |   13 |     3 |      26 |
| `attributes_test.rb`             |     7 |    9 |     1 |      17 |
| `attribute_assignment_test.rb`   |     5 |    7 |     1 |      13 |
| `type/string_test.rb`            |     2 |    2 |     0 |       4 |
| **total**                        |    65 |   93 |    25 | **183** |
...
Seven files, 183 mismatches total, largest single file 43 — comfortably one PR.
Four of them carry TS-only extras (`attribute_set_test.rb` 12,
`attribute_methods_test.rb` 10, `attribute_assignment_test.rb` 9,
`attribute_registration_test.rb` 7); those are the `.trails.test.ts` bucket.
