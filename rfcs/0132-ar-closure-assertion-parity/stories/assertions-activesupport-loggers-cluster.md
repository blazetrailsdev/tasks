...
priority: 5
pr: trails#7945
claim: "2026-09-22T01:35:43Z"
assignee: "assertions-activesupport-loggers-cluster"
blocked-by: null
closed-reason: null
---
...
The logger / error-reporting cluster.

| Rails file                         | count | kind | value |   total |
| ---------------------------------- | ----: | ---: | ----: | ------: |
| `broadcast_logger_test.rb`         |     7 |   31 |     0 |      38 |
| `logger_test.rb`                   |    11 |   14 |     1 |      26 |
| `tagged_logging_test.rb`           |     8 |    9 |     3 |      20 |
| `rescuable_test.rb`                |     2 |    4 |     3 |       9 |
| `error_reporter_test.rb`           |     2 |    3 |     0 |       5 |
| `clean_logger_test.rb`             |     1 |    1 |     1 |       3 |
| `backtrace_cleaner_test.rb`        |     0 |    2 |     0 |       2 |
| `isolated_execution_state_test.rb` |     1 |    1 |     0 |       2 |
| `log_subscriber_test.rb`           |     1 |    1 |     0 |       2 |
| `reloader_test.rb`                 |     0 |    2 |     0 |       2 |
| **total**                          |    33 |   68 |     8 | **109** |
...
109 mismatches over 10 files, largest 38 — one PR. `broadcast_logger_test.rb`
is kind-dominated (31 of 38), which usually means a systematic idiom difference
across the file rather than 31 separate decisions; find it once.
`tagged_logging_test.rb` carries 16 TS-only extras and `logger_test.rb` 15 —
the `.trails.test.ts` bucket.

Related but NOT in this story: `assertions-activesupport-logging-deprecation-
callbacks-broadcast-remainder` owns `notifications_test.rb`.
