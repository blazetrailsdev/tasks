---
title: "assertion parity tail: adapters files, batch 1"
status: done
updated: 2026-09-18
...
priority: 5
pr: trails#7876
claim: "2026-09-18T20:17:51Z"
assignee: "assertions-tail-adapters-1"
blocked-by: null
closed-reason: null
---
...
| --------------------------------------------------------------- | ----: | ---: | ----: |
| `connection_adapters/schema_cache_test.rb`                      |    13 |   20 |     0 |
| `adapters/postgresql/uuid_test.rb`                              |    15 |   18 |     0 |
| `connection_adapters/connection_handler_test.rb`                |     9 |   17 |     0 |
| `adapters/postgresql/enum_test.rb`                              |     7 |   11 |     6 |
| `adapters/mysql2/mysql2_adapter_test.rb`                        |     8 |   14 |     0 |
| `connection_adapters/connection_handlers_multi_db_test.rb`      |     9 |    9 |     1 |
| `adapters/postgresql/bytea_test.rb`                             |     7 |   10 |     0 |
| `adapters/abstract_mysql_adapter/connection_test.rb`            |     6 |   10 |     0 |

**190 divergences** (74 assertion-count, 109 assertion-kind, 7
