...
| --------------------------------------------------------------- | ----: | ---: | ----: |
| `validations/uniqueness_validation_test.rb`                     |    13 |   39 |     0 |
| `encryption/encryptable_record_test.rb`                         |    14 |   25 |     1 |
| `validations_test.rb`                                           |     0 |   17 |     0 |
| `validations/numericality_validation_test.rb`                   |     0 |   14 |     0 |
| `encryption/encryptor_test.rb`                                  |     5 |    7 |     0 |
| `validations/association_validation_test.rb`                    |     1 |   10 |     0 |
| `validations/presence_validation_test.rb`                       |     0 |    8 |     0 |
| `validations/length_validation_test.rb`                         |     2 |    5 |     0 |
| `encryption/scheme_test.rb`                                     |     1 |    3 |     0 |
| `encryption/configurable_test.rb`                               |     1 |    2 |     0 |

**168 divergences** (37 assertion-count, 130 assertion-kind, 1
