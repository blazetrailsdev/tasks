---
title: "Burn down 57 extra (TS-only) tests in uniqueness-validation.test.ts"
status: in-progress
updated: 2026-06-25
...
`packages/activerecord/src/validations/uniqueness-validation.test.ts` carries **57 extra (TS-only) tests** -- `it`/`test`
...
`vendor/rails/activerecord/test/cases/validations/uniqueness_validation_test.rb`.
...
- **One file per PR:** touch only `packages/activerecord/src/validations/uniqueness-validation.test.ts` (optionally its sibling
