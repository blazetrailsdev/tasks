...
| [extractor-capture-singleton-class-attr-accessor-config](stories/extractor-capture-singleton-class-attr-accessor-config.md) | api-compare: capture singleton_class.attr_accessor module config as Base statics                                                                                                                          | claimed     | 200     | —           |
