...
| ----------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------- | ----------- |
| [extractor-capture-metaprogrammed-ruby-surface](stories/extractor-capture-metaprogrammed-ruby-surface.md)         | api-compare extractor: capture class_attribute/alias/delegate-generated Ruby methods                                                                                                                      | draft  | 200     | —           |
| [gate-extractor-capture-capability-wrappers](stories/gate-extractor-capture-capability-wrappers.md)               | test-compare gate extractor: capture respond_to?/supports_X? module wrappers                                                                                                                              | draft  | 150     | —           |
