...
| --------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------- | ----------- |
| [api-compare-resolve-alias-arity](stories/api-compare-resolve-alias-arity.md)                                               | api-compare: resolve Ruby alias arity to target so faithful TS delegators don't false-flag                                                                                                                | ready  | 150     | —           |
