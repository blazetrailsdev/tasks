...
| ----------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------- | ----------- |
| [extractor-capture-metaprogrammed-ruby-surface](stories/extractor-capture-metaprogrammed-ruby-surface.md)         | api-compare extractor: capture class_attribute/alias/delegate-generated Ruby methods                                                                                                                      | ready  | 200     | —           |
