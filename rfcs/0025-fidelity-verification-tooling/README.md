...
| --------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------- | ----------- |
| [extra-surface-walkmixin-unported-guard](stories/extra-surface-walkmixin-unported-guard.md)                                 | api-compare: apply isSourceUnported guard to extra-surface walkMixin (parity with compare.ts)                                                                                                             | ready       | 40      | —           |
...
| [converge-relation-wherevalues-to-whereclause](stories/converge-relation-wherevalues-to-whereclause.md)                     | converge-relation-wherevalues-to-whereclause                                                                                                                                                              | claimed     | null    | —           |
| [extractor-capture-enumerable-metaprogrammed-surface](stories/extractor-capture-enumerable-metaprogrammed-surface.md)       | extractor-capture-enumerable-metaprogrammed-surface                                                                                                                                                       | in-progress | null    | —           |
| [extractor-capture-globalid-mixin-surface](stories/extractor-capture-globalid-mixin-surface.md)                             | api-compare: resolve cross-package GlobalID mixin into AR Base allowed-set                                                                                                                                | in-progress | 150     | —           |
| [extractor-capture-singleton-class-attr-accessor-config](stories/extractor-capture-singleton-class-attr-accessor-config.md) | api-compare: capture singleton_class.attr_accessor module config as Base statics                                                                                                                          | in-progress | 200     | —           |
