...
| [cross-version-api-drift-report](stories/cross-version-api-drift-report.md)                                                 | Cross-version Rails API drift report (upgrade worklist), scoped to ported surface                                                                                                                         | claimed     | 250     | —           |
| [extractor-capture-super-calls](stories/extractor-capture-super-calls.md)                                                   | Capture super calls in both extractors for call-set parity                                                                                                                                                | claimed     | 120     | —           |
