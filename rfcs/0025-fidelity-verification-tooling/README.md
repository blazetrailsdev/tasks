...
| [rails-error-parity-bare-throw-burndown-continue](stories/rails-error-parity-bare-throw-burndown-continue.md)     | Continue rails-error-parity bare-throw burndown (ar/am remaining ~126 files); port missing Ruby bases (RuntimeError, FrozenError) needed by guard sites                                                   | claimed | 300     | —           |
