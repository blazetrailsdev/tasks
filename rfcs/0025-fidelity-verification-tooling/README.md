...
| [no-raw-sql-scope-sink-sql-arg](stories/no-raw-sql-scope-sink-sql-arg.md)                                     | no-raw-sql: only flag the SQL argument of sink calls, not op-name labels                                                                                                                                  | claimed | 80      | —           |
