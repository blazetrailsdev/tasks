...
| [extra-surface-walkmixin-unported-guard](stories/extra-surface-walkmixin-unported-guard.md)                                 | api-compare: apply isSourceUnported guard to extra-surface walkMixin (parity with compare.ts)                                                                                                             | claimed     | 40      | —           |
