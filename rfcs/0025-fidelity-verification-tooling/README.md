...
| ------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------- | ----------- |
| [rails-error-parity-bare-throw-burndown-continue](stories/rails-error-parity-bare-throw-burndown-continue.md) | Continue rails-error-parity bare-throw burndown (ar/am remaining ~126 files); port missing Ruby bases (RuntimeError, FrozenError) needed by guard sites                                                   | draft  | 300     | —           |
| [no-raw-sql-scope-sink-sql-arg](stories/no-raw-sql-scope-sink-sql-arg.md)                                     | no-raw-sql: only flag the SQL argument of sink calls, not op-name labels                                                                                                                                  | ready  | 80      | —           |
