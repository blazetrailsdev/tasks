...
| [extractor-scan-umbrella-module-config-to-base](stories/extractor-scan-umbrella-module-config-to-base.md)                   | Scan top-level umbrella module config into ActiveRecord::Base, drop curated allowlist                                                                                                                     | done   | 250     | —           |
