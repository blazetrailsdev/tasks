...
assignee: null
blocked-by: null
closed-reason: "superseded by converge-abstractadapter-superset-then-delete-barrel; barrel deletion reachable only after that convergence (AbstractAdapter is not the TS-level superset)"
---
