...
| ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ----------- | ------- | --------------- |
| [poolconfig-discard-pool-use-discard-not-disconnect](stories/poolconfig-discard-pool-use-discard-not-disconnect.md)     | PoolConfig#discardPoolBang should call pool.discard! not disconnect! (Rails parity)                                                              | ready       | 60      | —               |
| [repoint-adapter-barrel-imports-then-delete](stories/repoint-adapter-barrel-imports-then-delete.md)                     | repoint-adapter-barrel-imports-then-delete                                                                                                       | ready       | null    | —               |
| [sqlite-db-path-expansion-mkdir](stories/sqlite-db-path-expansion-mkdir.md)                                             | SQLite3Adapter: expand DB path + create parent dir (Rails initialize parity)                                                                     | ready       | 80      | —               |
| [converge-abstractadapter-superset-then-delete-barrel](stories/converge-abstractadapter-superset-then-delete-barrel.md) | converge-abstractadapter-superset-then-delete-barrel                                                                                             | in-progress | null    | —               |
...
| [adapter-hash-only-constructor](stories/adapter-hash-only-constructor.md)                                               | Adapter hash-only constructor (Initiative 3)                                                                                                     | done        | 150     | adapter-cleanup |
...
| [async-sqlite-drain-reload-flush-discard-seams](stories/async-sqlite-drain-reload-flush-discard-seams.md)               | Drain async SQLite close on remaining pool teardown seams (clearReloadableConnections / flush / discardBang / swap-discard / PoolConfig discard) | done        | 200     | —               |
...
| [pr-a-delete-adapter-barrel](stories/pr-a-delete-adapter-barrel.md)                                                     | PR A — delete adapter.ts barrel + DatabaseAdapter interface                                                                                      | blocked     | 150     | adapter-cleanup |
