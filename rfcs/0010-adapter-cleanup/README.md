...
| ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------- | ------- | --------------- |
| [async-sqlite-pool-teardown-drain](stories/async-sqlite-pool-teardown-drain.md)                       | Drain async SQLite driver close() at pool-level teardown (await \_closingDriver through ConnectionPool/PoolConfig) | draft   | 200     | —               |
