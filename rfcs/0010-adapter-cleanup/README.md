...
| [pr-a-delete-adapter-barrel](stories/pr-a-delete-adapter-barrel.md)                                                     | PR A — delete adapter.ts barrel + DatabaseAdapter interface                                                                                      | claimed     | 150     | adapter-cleanup |
| [adapter-hash-only-constructor](stories/adapter-hash-only-constructor.md)                                               | Adapter hash-only constructor (Initiative 3)                                                                                                     | in-progress | 150     | adapter-cleanup |
