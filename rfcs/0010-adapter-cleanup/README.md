...
| [async-sqlite-drain-reload-flush-discard-seams](stories/async-sqlite-drain-reload-flush-discard-seams.md) | Drain async SQLite close on remaining pool teardown seams (clearReloadableConnections / flush / discardBang / swap-discard / PoolConfig discard) | claimed     | 200     | —               |
