...
| ------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ----------- | ------- | ------- |
| [widen-writefromuser-strict-after-warm](stories/widen-writefromuser-strict-after-warm.md)                     | Widen writeFromUser to the Rails one-liner once the schema cache is warm at construction       | in-progress | 120     | —       |
...
| [remove-cold-cache-insert-reflection-fallback](stories/remove-cold-cache-insert-reflection-fallback.md)       | remove-cold-cache-insert-reflection-fallback                                                   | done        | 60      | —       |
