...
| ------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ----------- | ------- | ------- |
| [ddl-rename-column-index-invalidate-schema-cache](stories/ddl-rename-column-index-invalidate-schema-cache.md) | renameColumn/renameIndex must invalidate the schema cache (always-warm latent staleness)       | draft       | 80      | —       |
| [remove-cold-cache-insert-reflection-fallback](stories/remove-cold-cache-insert-reflection-fallback.md)       | remove-cold-cache-insert-reflection-fallback                                                   | draft       | 60      | —       |
...
| [r2-drop-synthesize-converge-adhoc-model-tests](stories/r2-drop-synthesize-converge-adhoc-model-tests.md)     | R2: drop synthesize-from-attributes for table-backed models; converge ad-hoc-model tests       | in-progress | 250     | —       |
