...
| --------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ------ | ------- | ------- |
| [r2-drop-synthesize-converge-adhoc-model-tests](stories/r2-drop-synthesize-converge-adhoc-model-tests.md) | R2: drop synthesize-from-attributes for table-backed models; converge ad-hoc-model tests | draft  | 250     | —       |
