...
| ------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ------- | ------- | ------- |
| [widen-writefromuser-strict-after-warm](stories/widen-writefromuser-strict-after-warm.md)                     | Widen writeFromUser to the Rails one-liner once the schema cache is warm at construction       | claimed | 120     | —       |
