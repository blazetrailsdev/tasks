...
| [schema-cache-custom-primary-key-inference](stories/schema-cache-custom-primary-key-inference.md)             | Schema cache should expose custom primary key for id:false tables (drop explicit \_primaryKey) | claimed     | 120     | —       |
