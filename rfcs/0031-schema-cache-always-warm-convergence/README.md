...
| [ddl-rename-column-index-invalidate-schema-cache](stories/ddl-rename-column-index-invalidate-schema-cache.md) | renameColumn/renameIndex must invalidate the schema cache (always-warm latent staleness)       | claimed | 80      | —       |
