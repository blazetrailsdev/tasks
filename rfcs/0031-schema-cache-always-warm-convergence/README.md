...
| [r1-eager-persistent-schema-cache-test-harness](stories/r1-eager-persistent-schema-cache-test-harness.md)     | R1: eager-warm + persistent per-test schema cache in the AR test harness                       | in-progress | 150     | —       |
