...
assignee: null
blocked-by: null
closed-reason: "Already done: encryption/contexts.ts:42 (_defaultContext ??= new Context()) and :134 (resetDefaultContext -> new Context()); no bare object literal remains."
---
