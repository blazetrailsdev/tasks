...
- [x] No regression in collection-proxy / has-many suites (finder-methods, finder, associations, has-many-associations, has-many-through, delegation all pass; parity:api & parity:test non-negative).
