...
assignee: null
blocked-by: null
closed-reason: "Not Rails-convergent: a repo style cleanup (node:fs sync -> async surface, 31 *Sync sites) in a test file. Rails' database_tasks tests use plain File/Dir; nothing about the port's behavior changes."
---
