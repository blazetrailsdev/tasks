...
assignee: null
blocked-by: null
closed-reason: "merged into converge-model-validates-onto-rails-generic-lookup — Rails' 'You need to supply at least one validation' ArgumentError (validates.rb:106) falls out of that rewrite"
---
