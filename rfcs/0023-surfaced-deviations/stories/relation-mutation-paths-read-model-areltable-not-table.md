...
assignee: null
blocked-by: null
closed-reason: "Already done: relation.ts updateAll (:3736), deleteAll (:3812), updateCounters (:5918) and _substituteValues (:6852) all read this.table; no _modelClass.arelTable reads remain."
---
