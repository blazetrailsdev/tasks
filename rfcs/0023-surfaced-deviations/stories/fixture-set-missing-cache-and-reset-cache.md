...
assignee: null
blocked-by: null
closed-reason: "Test-helper caching whose Rails motivation (repeated create_fixtures per suite) is displaced by trails' per-worker template/clone model; no Rails behaviour diverges in ported code."
---
