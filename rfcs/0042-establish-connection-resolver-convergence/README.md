...
| ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ----------- | ------- | ------- |
| [infer-adapter-at-config-build-for-schemeless-url](stories/infer-adapter-at-config-build-for-schemeless-url.md)               | Infer adapter at config-build time for scheme-less URL shorthand                                  | ready       | 60      | —       |
| [funnel-autoconnect-through-object-path](stories/funnel-autoconnect-through-object-path.md)                                   | Funnel autoConnect through the single DatabaseConfig object path                                  | in-progress | 100     | —       |
