...
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ----------- | ------- | ------------ |
| [predicate-builder-force-equality-uniform-build](stories/predicate-builder-force-equality-uniform-build.md) | Lift force_equality? to uniform build dispatch (PG array + serialized)                          | ready       | null    | —            |
