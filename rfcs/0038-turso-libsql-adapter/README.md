...
| --------------------------------------------------------------- | ----------------------------------------------------------- | ----------- | ------- | --------------------- |
| [libsql-replica-auto-sync](stories/libsql-replica-auto-sync.md) | libsql: opt-in periodic auto-sync for embedded replicas     | draft       | 120     | —                     |
| [libsql-embedded-replica](stories/libsql-embedded-replica.md)   | libsql: embedded-replica mode + sync()                      | in-progress | 160     | adapter-test-fidelity |
