...
**This story (~210 moved lines):** `addColumn`, `changeColumn`
(~62), `renameColumn`, `changeColumnDefault`, `buildChangeColumnDefinition`,
`buildChangeColumnDefaultDefinition`, `changeColumnNull`,
`changeColumnComment`, `changeTableComment`, and `createJoinTable`.
