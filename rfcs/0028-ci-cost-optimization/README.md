...
| [ar-test-reset-signature-cache-no-blanket-clear](stories/ar-test-reset-signature-cache-no-blanket-clear.md)                       | dropAllTables: reconcile signature cache instead of blanket clear (Path C)              | claimed | 80      | —                    |
