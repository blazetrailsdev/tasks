...
| [ar-test-reset-drop-table-churn](stories/ar-test-reset-drop-table-churn.md)                                                       | Eliminate per-file mass DROP TABLE teardown churn (86k drops/run)                       | ready       | 250     | —                    |
...
| [trails-tsc-coverage-isolation](stories/trails-tsc-coverage-isolation.md)                                                         | Collect trails-tsc coverage without voiding the shared run                              | in-progress | 60      | —                    |
