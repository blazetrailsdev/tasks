...
| [decouple-ar-slot-pool-from-worker-count](stories/decouple-ar-slot-pool-from-worker-count.md)                                     | Decouple AR advisory-slot pool from vitest worker count (add headroom)                  | claimed     | 40      | —                    |
