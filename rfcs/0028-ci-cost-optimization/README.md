...
| [ar-test-reset-verify-raw-sql-burndown-churn-payoff](stories/ar-test-reset-verify-raw-sql-burndown-churn-payoff.md)               | Verify the dropAllTables distinct-table fan-out actually shrank after the raw-SQL teardown burndown | in-progress | 40      | —                    |
