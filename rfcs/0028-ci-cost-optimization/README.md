...
| [ar-test-reset-raw-sql-teardown-burndown](stories/ar-test-reset-raw-sql-teardown-burndown.md)                                     | Burn down require-table-teardown raw-SQL grandfather list to zero (Path D)              | claimed     | 300     | —                    |
