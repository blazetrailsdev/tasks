...
| [ar-test-reset-drop-table-churn](stories/ar-test-reset-drop-table-churn.md)                                                       | Spike: locate the dominant DROP TABLE source in AR test teardown (86k/run)              | claimed | 60      | —                    |
