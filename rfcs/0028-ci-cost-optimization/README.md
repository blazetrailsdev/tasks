...
| [decouple-ar-slot-pool-from-worker-count](stories/decouple-ar-slot-pool-from-worker-count.md)         | Decouple AR advisory-slot pool from vitest worker count (add headroom)          | draft       | 40      | —                    |
...
| [schema-dumping-schemas-timeout-flake](stories/schema-dumping-schemas-timeout-flake.md)               | Fix recurring 'dumping schemas' 5s timeout flake in postgresql/schema.test.ts   | draft       | 15      | —                    |
...
| [tune-ar-db-forks-to-runner-cores](stories/tune-ar-db-forks-to-runner-cores.md)                       | Right-size AR_DB_FORKS to the runner core count                                 | in-progress | 30      | parallelism-rounding |
