...
| [trails-tsc-coverage-isolation](stories/trails-tsc-coverage-isolation.md)                             | Collect trails-tsc coverage without voiding the shared run                      | ready       | 60      | —                    |
| [consolidate-leaf-test-jobs](stories/consolidate-leaf-test-jobs.md)                                   | Consolidate the tiny leaf test jobs into one affected-aware job                 | in-progress | 160     | parallelism-rounding |
| [consolidate-preflight-micro-jobs](stories/consolidate-preflight-micro-jobs.md)                       | Consolidate the sub-minute preflight checks into one job to reclaim rounding    | in-progress | 120     | parallelism-rounding |
