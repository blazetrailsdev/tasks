...
Post/Author/Comment/Category fixtures. This story converts the **default-scope** cluster:
the `eager with default scope *` tests still declared as ad-hoc per-test models against the inline
