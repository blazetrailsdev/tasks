...
Post/Author/Comment/Category fixtures. This story converts the **preloading (through, instance-dependent, scoping)** cluster:
the `preloading has many through * / instance-dependent / scoping` tests still declared as ad-hoc per-test models against the inline
