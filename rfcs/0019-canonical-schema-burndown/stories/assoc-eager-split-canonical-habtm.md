---
title: "eager.test.ts → canonical: habtm cluster"
status: in-progress
updated: 2026-06-26
...
priority: 40
pr: 4181
claim: "2026-06-26T10:27:51Z"
assignee: "assoc-eager-split-canonical-habtm"
blocked-by: null
---
...
Post/Author/Comment/Category fixtures. This story converts the **habtm** cluster:
the `eager association loading with habtm * / eager with has and belongs to many and limit` tests still declared as ad-hoc per-test models against the inline
