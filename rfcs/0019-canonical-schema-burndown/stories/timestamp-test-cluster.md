...
- `packages/activerecord/src/timestamp.test.ts` → `timestamp_test.rb`
...
Largest source file (~1010 LOC); will almost certainly need multiple &le;300 LOC
slices registered as separate stories.
