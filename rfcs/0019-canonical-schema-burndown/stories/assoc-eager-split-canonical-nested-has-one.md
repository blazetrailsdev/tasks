...
Post/Author/Comment/Category fixtures. This story converts the **nested loading through has_one** cluster:
the `nested loading through has one association *` tests still declared as ad-hoc per-test models against the inline
