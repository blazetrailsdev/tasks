...
Post/Author/Comment/Category fixtures. This story converts the **has_many-through** cluster:
the `eager with has many through *` tests still declared as ad-hoc per-test models against the inline
