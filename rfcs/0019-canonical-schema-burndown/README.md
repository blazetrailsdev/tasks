...
| [assoc-has-one-unskip-residual](stories/assoc-has-one-unskip-residual.md)                                                             | assoc-has-one-unskip-residual                                                                                                                                               | claimed     | null    | —        |
...
| [assoc-has-one-shared-tables](stories/assoc-has-one-shared-tables.md)                                                                 | Convert has-one-associations.test.ts bespoke firms/accounts/companies to canonical                                                                                          | in-progress | 500     | —        |
| [assoc-join-model-canonical-wave2](stories/assoc-join-model-canonical-wave2.md)                                                       | join-model.test.ts → canonical: mutating polymorphic (wave 2)                                                                                                               | in-progress | 450     | fixtures |
| [converge-named-scoping-canonical](stories/converge-named-scoping-canonical.md)                                                       | Converge scoping/named-scoping.test.ts to canonical models                                                                                                                  | in-progress | 250     | fixtures |
