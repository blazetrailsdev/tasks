...
| [require-table-teardown-burndown-migration](stories/require-table-teardown-burndown-migration.md)                                     | Burn down require-table-teardown: migration/DDL feature tests (invertible-migration, migration, query-cache, reserved-word, schema-dumper, schema-introspection, timestamp) | ready       | 300     | —        |
