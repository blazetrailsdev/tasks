...
| [canonicalize-hasone-autosave-block](stories/canonicalize-hasone-autosave-block.md)                                                   | canonicalize-hasone-autosave-block                                                                                                                                          | ready       | null    | —        |
...
| [canonicalize-nested-autosave-blocks](stories/canonicalize-nested-autosave-blocks.md)                                                 | Canonicalize nested-attributes autosave describe blocks (Rails-guided + HasOne/HasMany autosave)                                                                            | in-progress | 350     | —        |
| [canonicalize-nested-belongs-to-block](stories/canonicalize-nested-belongs-to-block.md)                                               | Canonicalize TestNestedAttributesOnABelongsToAssociation makeModels() block                                                                                                 | in-progress | 180     | —        |
