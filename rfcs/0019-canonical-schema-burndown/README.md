...
| [assoc-associations-test](stories/assoc-associations-test.md)                                                     | Port associations.test.ts to canonical schema (split per-describe)                                                                                                          | draft       | 500     | fixtures |
...
| [assoc-cascaded-eager-canonical](stories/assoc-cascaded-eager-canonical.md)                                       | cascaded-eager-loading.test.ts → canonical schema                                                                                                                           | draft       | 250     | fixtures |
...
| [assoc-habtm-canonical](stories/assoc-habtm-canonical.md)                                                         | habtm + has-and-belongs-to-many → canonical schema (split)                                                                                                                  | draft       | 500     | fixtures |
| [assoc-has-many](stories/assoc-has-many.md)                                                                       | Port has-many-associations.test.ts to canonical schema (split per-describe)                                                                                                 | draft       | 500     | fixtures |
...
| [assoc-has-one](stories/assoc-has-one.md)                                                                         | Port has-one-associations.test.ts to canonical schema                                                                                                                       | draft       | 500     | fixtures |
| [assoc-join-model-canonical](stories/assoc-join-model-canonical.md)                                               | join-model.test.ts → canonical schema (split)                                                                                                                               | draft       | 500     | fixtures |
