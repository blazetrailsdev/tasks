...
| [require-table-teardown-burndown-schema-statements](stories/require-table-teardown-burndown-schema-statements.md)                     | Burn down require-table-teardown: abstract-mysql active-schema + schema-statements-on-adapter test files                                                                    | claimed     | 200     | —        |
