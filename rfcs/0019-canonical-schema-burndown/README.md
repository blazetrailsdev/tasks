...
| [require-table-teardown-burndown-pg-adapters](stories/require-table-teardown-burndown-pg-adapters.md)                                 | Burn down require-table-teardown: 6 postgresql adapter test files (collation, invertible-migration, range, schema, uuid, virtual-column)                                    | ready       | 250     | —        |
