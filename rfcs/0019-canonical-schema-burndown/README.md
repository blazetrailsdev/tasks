...
| [assoc-join-model-canonical-wave4](stories/assoc-join-model-canonical-wave4.md)                                                       | join-model.test.ts → canonical: STI/self-ref/preload (wave 4)                                                                                                               | claimed | 490     | fixtures |
