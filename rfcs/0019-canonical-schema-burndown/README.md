...
| [assoc-associations-test-wave2-delete-dup-describes](stories/assoc-associations-test-wave2-delete-dup-describes.md) | associations.test.ts wave 2: delete remaining duplicate describes (RFC 0019)                                                                                                | ready       | 500     | —        |
...
| [assoc-has-one](stories/assoc-has-one.md)                                                                           | Port has-one-associations.test.ts to canonical schema                                                                                                                       | in-progress | 500     | fixtures |
