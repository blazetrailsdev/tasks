...
| [bidirectional-destroy-dependent-cycle-guard](stories/bidirectional-destroy-dependent-cycle-guard.md)             | bidirectional-destroy-dependencies → canonical fixtures (needs dependent-destroy cycle guard)                                                                               | ready       | 120     | fixtures |
...
| [assoc-eager-split-canonical](stories/assoc-eager-split-canonical.md)                                             | eager.test.ts → canonical schema (multi-PR split)                                                                                                                           | in-progress | 500     | fixtures |
| [assoc-habtm-canonical](stories/assoc-habtm-canonical.md)                                                         | habtm + has-and-belongs-to-many → canonical schema (split)                                                                                                                  | in-progress | 500     | fixtures |
| [assoc-has-one](stories/assoc-has-one.md)                                                                         | Port has-one-associations.test.ts to canonical schema                                                                                                                       | in-progress | 500     | fixtures |
| [assoc-join-model-canonical](stories/assoc-join-model-canonical.md)                                               | join-model.test.ts → canonical schema (split)                                                                                                                               | in-progress | 500     | fixtures |
