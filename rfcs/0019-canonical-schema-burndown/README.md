...
| [persistence-test-canonical-wave10](stories/persistence-test-canonical-wave10.md)                                                     | persistence.test.ts canonical burndown wave10 (remaining defineSchema blocks)                                                                                               | ready       | 300     | —        |
| [primary-key-reflects-nil-for-idless-tables](stories/primary-key-reflects-nil-for-idless-tables.md)                                   | primary-key-reflects-nil-for-idless-tables                                                                                                                                  | ready       | null    | —        |
...
| [persistence-port-residual-cluster](stories/persistence-port-residual-cluster.md)                                                     | persistence-port-residual-cluster                                                                                                                                           | in-progress | null    | —        |
...
| [persistence-test-canonical-wave9](stories/persistence-test-canonical-wave9.md)                                                       | persistence-test-canonical-wave9                                                                                                                                            | in-progress | null    | —        |
