...
| [require-table-teardown-ratchet-burndown](stories/require-table-teardown-ratchet-burndown.md)                                         | Burn down require-table-teardown exclude baseline (18 files)                                                                                                                | in-progress | 300     | —        |
| [require-table-teardown-rule-recognize-loops](stories/require-table-teardown-rule-recognize-loops.md)                                 | Harden require-table-teardown rule to recognize loop/array-based teardown                                                                                                   | in-progress | 60      | —        |
