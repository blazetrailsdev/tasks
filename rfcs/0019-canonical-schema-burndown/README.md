...
| [assoc-has-one-writer-persist](stories/assoc-has-one-writer-persist.md)                                                               | assoc-has-one-writer-persist                                                                                                                                                | claimed     | 120     | —        |
| [harden-orders-table-shared-db-collision](stories/harden-orders-table-shared-db-collision.md)                                         | aggregations.test.ts redefines orders without billing/shipping cols, poisons autosave-association on shared worker DB                                                       | in-progress | 40      | —        |
