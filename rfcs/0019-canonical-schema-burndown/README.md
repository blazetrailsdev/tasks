...
| [timestamp-alias-resolution-fidelity](stories/timestamp-alias-resolution-fidelity.md)                                                 | Resolve attribute aliases in timestamp/cache-key reads (Rails timestamp.rb parity)                                                                                          | claimed | 200     | fixtures |
