...
| [assoc-join-model-canonical-wave2](stories/assoc-join-model-canonical-wave2.md)                                                       | join-model.test.ts → canonical: mutating polymorphic (wave 2)                                                                                                               | claimed     | 450     | fixtures |
