...
| [require-table-teardown-burndown-pg-adapters](stories/require-table-teardown-burndown-pg-adapters.md)                                 | Burn down require-table-teardown: 6 postgresql adapter test files (collation, invertible-migration, range, schema, uuid, virtual-column)                                    | in-progress | 250     | —        |
| [require-table-teardown-burndown-schema-statements](stories/require-table-teardown-burndown-schema-statements.md)                     | Burn down require-table-teardown: abstract-mysql active-schema + schema-statements-on-adapter test files                                                                    | in-progress | 200     | —        |
