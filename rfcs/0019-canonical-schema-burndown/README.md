...
| [cpk-counter-cache-columns-pending-flush](stories/cpk-counter-cache-columns-pending-flush.md)                                         | fix: CpkOrder.\_counterCacheColumns gets cpk_books_count from pending flush instead of books_count                                                                          | in-progress | 30      | —        |
| [dup-initialize-dup-convergence](stories/dup-initialize-dup-convergence.md)                                                           | dup-initialize-dup-convergence                                                                                                                                              | in-progress | null    | —        |
