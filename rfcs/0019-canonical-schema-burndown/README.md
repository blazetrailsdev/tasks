...
| [nested-attr-hasmany-fk-from-reflection](stories/nested-attr-hasmany-fk-from-reflection.md)                                           | nested-attr-hasmany-fk-from-reflection                                                                                                                                      | ready       | null    | —        |
...
| [canonicalize-nested-top-block](stories/canonicalize-nested-top-block.md)                                                             | Canonicalize NestedAttributesTest top block (bespoke per-test class pairs, lines 202-564)                                                                                   | claimed     | 250     | —        |
...
| [canonicalize-nested-small-blocks](stories/canonicalize-nested-small-blocks.md)                                                       | Canonicalize ~15 single-test nested-attributes describe blocks (lines 1864-2680)                                                                                            | in-progress | 300     | —        |
