...
| [cpk-counter-cache-columns-pending-flush](stories/cpk-counter-cache-columns-pending-flush.md)                                         | fix: CpkOrder.\_counterCacheColumns gets cpk_books_count from pending flush instead of books_count                                                                          | ready   | 30      | —        |
...
| [hm-belongsto-inverse-cache-poisoned-after-collection-load](stories/hm-belongsto-inverse-cache-poisoned-after-collection-load.md)     | hm-belongsto-inverse-cache-poisoned-after-collection-load                                                                                                                   | claimed | null    | —        |
| [hm-clients-of-firm-delete-async-validate](stories/hm-clients-of-firm-delete-async-validate.md)                                       | hm-clients-of-firm-delete-async-validate                                                                                                                                    | claimed | null    | —        |
| [insert-all-test-canonical-conversion](stories/insert-all-test-canonical-conversion.md)                                               | insert-all-test-canonical-conversion                                                                                                                                        | claimed | null    | —        |
