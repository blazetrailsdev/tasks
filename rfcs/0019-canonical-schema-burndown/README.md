...
| [callbacks-destroy-on-parent-firm-clients-fidelity](stories/callbacks-destroy-on-parent-firm-clients-fidelity.md)                     | Use canonical Firm/clients for callbacks.test.ts destroy-on-parent test                                                                                                     | in-progress | 60      | —        |
| [nested-attr-hasmany-fk-from-reflection](stories/nested-attr-hasmany-fk-from-reflection.md)                                           | nested-attr-hasmany-fk-from-reflection                                                                                                                                      | in-progress | null    | —        |
