...
| [inverse-hasone-through-inverse-of](stories/inverse-hasone-through-inverse-of.md)                                                     | inverse-of: has_one :through automatic inverse (Firm/Project/Developer lead_developer)                                                                                      | claimed     | null    | fixtures |
| [inverse-cpk-build-composite-pk-child](stories/inverse-cpk-build-composite-pk-child.md)                                               | inverse-of: composite-PK build sets inverse on child (Cpk::Author/Book/Order)                                                                                               | in-progress | null    | fixtures |
