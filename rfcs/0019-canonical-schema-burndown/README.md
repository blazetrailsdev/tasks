...
| [assoc-associations-test-wave6-convert-canonical](stories/assoc-associations-test-wave6-convert-canonical.md)                         | assoc-associations-test-wave6-convert-canonical                                                                                                                             | ready       | null    | —        |
| [assoc-has-many-describes-wave5](stories/assoc-has-many-describes-wave5.md)                                                           | assoc-has-many-describes-wave5                                                                                                                                              | ready       | null    | —        |
...
| [converge-integration-test-canonical-developer](stories/converge-integration-test-canonical-developer.md)                             | Converge integration.test.ts to canonical Developer/Firm/fixtures                                                                                                           | ready       | 350     | fixtures |
...
| [timestamp-alias-resolution-fidelity](stories/timestamp-alias-resolution-fidelity.md)                                                 | Resolve attribute aliases in timestamp/cache-key reads (Rails timestamp.rb parity)                                                                                          | ready       | 200     | fixtures |
...
| [assoc-associations-test-wave5-convert-canonical](stories/assoc-associations-test-wave5-convert-canonical.md)                         | assoc-associations-test-wave5-convert-canonical                                                                                                                             | in-progress | null    | —        |
| [assoc-has-many-describes-wave4](stories/assoc-has-many-describes-wave4.md)                                                           | assoc-has-many-describes-wave4                                                                                                                                              | in-progress | null    | —        |
| [converge-partial-decl-models-updated-at](stories/converge-partial-decl-models-updated-at.md)                                         | Converge partial-declaration models that mask updated_at (cache-key/integration/associations/named-scoping)                                                                 | in-progress | 500     | fixtures |
