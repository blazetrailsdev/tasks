...
| --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ------ | ------- | ------------ |
| [pg-typemap-init-param-type-hole](stories/pg-typemap-init-param-type-hole.md)     | Remove HashLookupTypeMap cast in PG static initializeTypeMap (reconcile with base TypeMap) | ready  | 80      | —            |
