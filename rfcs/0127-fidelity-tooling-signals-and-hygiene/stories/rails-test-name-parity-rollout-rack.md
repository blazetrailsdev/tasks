---
title: "rails-test-name-parity-rollout-rack"
status: ready
updated: 2026-08-28
...
`rack` has 93 TS-only tests as of 2026-08-28, so it seeds to a real mark and then
burns down.

## Acceptance criteria

- `rack` is added to all four registrations, and its mark is seeded with
