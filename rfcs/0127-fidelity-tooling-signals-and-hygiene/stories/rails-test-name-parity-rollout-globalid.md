---
title: "rails-test-name-parity-rollout-globalid"
status: ready
updated: 2026-08-28
...
`globalid` has 48 TS-only tests as of 2026-08-28, so it seeds to a real mark and then
burns down.

## Acceptance criteria

- `globalid` is added to all four registrations, and its mark is seeded with
