---
title: "rails-test-name-parity-rollout-trailties"
status: ready
updated: 2026-08-28
...
`trailties` has 122 TS-only tests as of 2026-08-28, so it seeds to a real mark and then
burns down.

## Acceptance criteria

- `trailties` is added to all four registrations, and its mark is seeded with
