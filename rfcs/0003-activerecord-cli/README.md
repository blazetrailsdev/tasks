...
| --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------- | ------- | -------- |
| [tsserver-editor-plugin-rfc](stories/tsserver-editor-plugin-rfc.md)                     | Author RFC: tsserver / editor plugin (adopt + re-verify virtual-source-files Phase 2) | ready   | null    | —        |
| [sveltekit-kanban-example-rfc](stories/sveltekit-kanban-example-rfc.md)                 | Author RFC: SvelteKit example app (Kanban modeled on tasks/rfcs)                      | claimed | null    | —        |
