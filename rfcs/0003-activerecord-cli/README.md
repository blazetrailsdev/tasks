...
| --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------- | ------- | -------- |
| [tsserver-editor-plugin-rfc](stories/tsserver-editor-plugin-rfc.md)                     | Author RFC: tsserver / editor plugin (adopt + re-verify virtual-source-files Phase 2) | claimed | null    | —        |
