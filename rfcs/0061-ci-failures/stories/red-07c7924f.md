---
title: "Active Record PostgreSQL Tests (1) failing on main @07c7924f"
status: closed
updated: 2026-08-27
...
priority: 0
pr: null
claim: "2026-08-27T01:28:27Z"
assignee: "red-07c7924f"
blocked-by: null
closed-reason: "Fixed by #7109 (merged f5d2641f6): UniquenessCoveredByUniqueIndexAdapterResolutionTest called rebuildCanonicalTables(adapter, ['topics']) on a raw pool, dropping/recreating topics mid-run and wiping the leading-colon test's rows in the same worker DB — insert_all's row vanished before the read."
---
...
- Branch: `main`
- Failing commit: `07c7924f1dd8fc6d7a6dbf79b675239d91933164`
- Red since: 2026-08-27T01:27:52Z
- Failing checks:
  - `Active Record PostgreSQL Tests (1)` — <https://github.com/blazetrailsdev/trails/actions/runs/33029344837/job/98379145895>
- Latest run: <https://github.com/blazetrailsdev/trails/actions/runs/33029344837/job/98379145895>
...
git log -1 07c7924f1dd8fc6d7a6dbf79b675239d91933164        # what landed
git show 07c7924f1dd8fc6d7a6dbf79b675239d91933164 --stat   # and what it touched
```
