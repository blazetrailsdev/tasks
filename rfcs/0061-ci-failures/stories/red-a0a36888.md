---
title: "Active Record SQLite Tests failing on main @a0a36888"
status: closed
updated: 2026-08-26
...
priority: 0
pr: null
claim: "2026-08-26T21:36:52Z"
assignee: "red-a0a36888"
blocked-by: null
closed-reason: "Known intermittent flake, not a code break: 'leading-colon string writes > create and insert_all store a leading colon verbatim' (leading-colon-string-writes.trails.test.ts:56) — insertAll then where().first() returned null. Already filed as story leading-colon-insert-all-first-returns-null-flake (seen on main @691f6a0c0 SQLite and PR #7087 MariaDB, both passing on bare re-run). SQLite :memory:, PostgreSQL and MariaDB lanes were green on a0a36888; the file passes locally at that SHA repeatedly. Re-ran job 98331573514 with no code change: Active Record SQLite Tests now success."
---
...
- Branch: `main`
- Failing commit: `a0a3688885ded2c17520458ace4f66fb6abfed35`
- Red since: 2026-08-26T21:36:19Z
- Failing checks:
  - `Active Record SQLite Tests` — <https://github.com/blazetrailsdev/trails/actions/runs/33015202121/job/98331573514>
- Latest run: <https://github.com/blazetrailsdev/trails/actions/runs/33015202121/job/98331573514>
...
git log -1 a0a3688885ded2c17520458ace4f66fb6abfed35        # what landed
git show a0a3688885ded2c17520458ace4f66fb6abfed35 --stat   # and what it touched
```
