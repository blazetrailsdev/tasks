...
| [through-scope-join-not-in-subquery](stories/through-scope-join-not-in-subquery.md)                                                     | Through/HABTM proxy scope() uses id IN (subquery) instead of Rails' JOIN, deduping join-row multiplicity                 | claimed | 80      | —               |
