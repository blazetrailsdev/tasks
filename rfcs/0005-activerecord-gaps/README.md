...
| [where-hash-resolves-self-join-alias](stories/where-hash-resolves-self-join-alias.md)                                                   | where({ assocName: {...} }) resolves to the self-join alias when the association is joined under an AliasTracker alias   | claimed | 80      | —               |
