...
25 ported cases. `parity:test` still reports **11 missing** for
...
- [ ] Gates match Rails exactly — 0 gate-mismatch, 0 misplaced in `parity:test`.
- [ ] `parity:test` missing for `migration/columns_test.rb` drops by 4.
