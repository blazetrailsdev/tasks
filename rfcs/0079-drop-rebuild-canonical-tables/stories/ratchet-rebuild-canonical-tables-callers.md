...
caller count can only grow. Freeze the current caller list (RFC README baseline:
23 files) in a checked-in manifest and fail lint when a file outside it calls
