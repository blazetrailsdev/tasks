...
| --------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------- | ------- | -------------- |
| [thread-collector-preparable-for-statement-cache](stories/thread-collector-preparable-for-statement-cache.md)               | thread-collector-preparable-for-statement-cache                                                             | ready       | null    | —              |
| [revisit-statement-cache-find-skips-after-cache-routing](stories/revisit-statement-cache-find-skips-after-cache-routing.md) | Populate + introspect the connection statement pool so bind_parameter statement-cache tests pass            | in-progress | 250     | adapter        |
