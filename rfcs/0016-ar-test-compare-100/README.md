...
| ------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------- | ------- | -------------- |
| [restore-collector-preparable-threading-regressed-by-3601](stories/restore-collector-preparable-threading-regressed-by-3601.md) | fix(arel): restore collector.preparable threading reverted by #3601's stale squash                          | claimed | 250     | —              |
