...
| ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------- | ------- | -------------- |
| [adapter-select-all-accepts-relation](stories/adapter-select-all-accepts-relation.md)                                   | adapter-select-all-accepts-relation                                                                         | draft       | 40      | —              |
| [base-test-connection-default-timezone](stories/base-test-connection-default-timezone.md)                               | base-test-connection-default-timezone                                                                       | draft       | null    | —              |
| [base-test-copytable-readonly-includes](stories/base-test-copytable-readonly-includes.md)                               | base-test-copytable-readonly-includes                                                                       | draft       | null    | —              |
| [calculations-grouped-composite-fk-aggregate-coverage](stories/calculations-grouped-composite-fk-aggregate-coverage.md) | Cover sum/average/min/max for grouped composite-key belongs_to association                                  | draft       | 40      | —              |
...
| [f9g3b4-finder-eager-load-collection-ordering](stories/f9g3b4-finder-eager-load-collection-ordering.md)                 | f9g3b4-finder-eager-load-collection-ordering                                                                | in-progress | null    | —              |
| [locking-belongs-to-inverse-stale-state](stories/locking-belongs-to-inverse-stale-state.md)                             | locking-belongs-to-inverse-stale-state                                                                      | in-progress | null    | —              |
