...
| ------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------- | ------- | -------------- |
| [restore-collector-preparable-threading-regressed-by-3601](stories/restore-collector-preparable-threading-regressed-by-3601.md) | fix(arel): restore collector.preparable threading reverted by #3601's stale squash                          | in-progress | 250     | —              |
...
| [calculations-grouped-composite-fk-aggregate-coverage](stories/calculations-grouped-composite-fk-aggregate-coverage.md)         | Cover sum/average/min/max for grouped composite-key belongs_to association                                  | done        | 40      | —              |
...
| [persistence-dirty-pk-touch-reload-lock](stories/persistence-dirty-pk-touch-reload-lock.md)                                     | Honor id_in_database in touch/reload/pessimistic-lock row targeting                                         | done        | 90      | core-residuals |
| [persistence-query-constraints-where](stories/persistence-query-constraints-where.md)                                           | Route update/delete/destroy WHERE through \_query_constraints_hash                                          | done        | 100     | core-residuals |
| [preserve-queryattribute-binds-in-notification-payload](stories/preserve-queryattribute-binds-in-notification-payload.md)       | Preserve QueryAttribute bind objects on the sql.active_record payload (binds are logged)                    | done        | 120     | adapter        |
| [revisit-statement-cache-find-skips-after-cache-routing](stories/revisit-statement-cache-find-skips-after-cache-routing.md)     | Populate + introspect the connection statement pool so bind_parameter statement-cache tests pass            | done        | 250     | adapter        |
...
| [thread-collector-preparable-for-statement-cache](stories/thread-collector-preparable-for-statement-cache.md)                   | thread-collector-preparable-for-statement-cache                                                             | done        | null    | —              |
