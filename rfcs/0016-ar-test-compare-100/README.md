...
| ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------- | ------- | -------------- |
| [base-test-connection-fixed-time-with-time-zone](stories/base-test-connection-fixed-time-with-time-zone.md)             | base-test-connection-fixed-time-with-time-zone                                                              | draft       | 80      | —              |
...
| [calculations-grouped-composite-fk-aggregate-coverage](stories/calculations-grouped-composite-fk-aggregate-coverage.md) | Cover sum/average/min/max for grouped composite-key belongs_to association                                  | claimed     | 40      | —              |
...
| [base-test-connection-default-timezone](stories/base-test-connection-default-timezone.md)                               | base-test-connection-default-timezone                                                                       | in-progress | null    | —              |
