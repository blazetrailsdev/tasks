...
| --------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------- | ------- | -------------- |
| [revisit-statement-cache-find-skips-after-cache-routing](stories/revisit-statement-cache-find-skips-after-cache-routing.md) | Populate + introspect the connection statement pool so bind_parameter statement-cache tests pass            | claimed     | 250     | adapter        |
| [preserve-queryattribute-binds-in-notification-payload](stories/preserve-queryattribute-binds-in-notification-payload.md)   | Preserve QueryAttribute bind objects on the sql.active_record payload (binds are logged)                    | in-progress | 120     | adapter        |
