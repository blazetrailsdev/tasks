...
| [calculations-grouped-composite-fk-aggregate-coverage](stories/calculations-grouped-composite-fk-aggregate-coverage.md) | Cover sum/average/min/max for grouped composite-key belongs_to association                                  | in-progress | 40      | —              |
