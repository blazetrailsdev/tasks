...
| --------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------- | ------- | -------------- |
| [revisit-statement-cache-find-skips-after-cache-routing](stories/revisit-statement-cache-find-skips-after-cache-routing.md) | Populate + introspect the connection statement pool so bind_parameter statement-cache tests pass            | ready       | 250     | adapter        |
