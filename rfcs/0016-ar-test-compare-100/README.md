...
| --------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------ | ------- | -------------- |
| [preserve-queryattribute-binds-in-notification-payload](stories/preserve-queryattribute-binds-in-notification-payload.md)   | Preserve QueryAttribute bind objects on the sql.active_record payload (binds are logged)                    | ready  | 120     | adapter        |
