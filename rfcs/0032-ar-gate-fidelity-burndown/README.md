...
| [gate-missing-insert-all](stories/gate-missing-insert-all.md)                                 | Gate missing-gate tests in insert_all_test.rb (53)                                    | claimed     | 250     | missing-gate |
| [gate-missing-migration](stories/gate-missing-migration.md)                                   | Gate missing-gate tests in migration_test.rb (20)                                     | claimed     | 120     | missing-gate |
