...
| [adapter-prevent-writes-encoding-should-gate](stories/adapter-prevent-writes-encoding-should-gate.md)                 | adapter-prevent-writes-encoding-should-gate                                           | in-progress | null    | —            |
