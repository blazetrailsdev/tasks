...
| [gate-extractor-mysql2-trilogy-prepared-artifacts](stories/gate-extractor-mysql2-trilogy-prepared-artifacts.md)       | Fix extractor Mysql2/Trilogy collapse and prepared_statements over-exclusion          | ready       | null    | —            |
| [invertible-migration-mysql-check-constraint-revert](stories/invertible-migration-mysql-check-constraint-revert.md)   | Converge check-constraint revert test; verify mysql revert path                       | ready       | null    | —            |
| [migration-bulk-alter-generic-body](stories/migration-bulk-alter-generic-body.md)                                     | Converge bulk_alter migration tests to generic adapter bodies                         | ready       | null    | —            |
| [schema-dumper-mysql-expression-index-dump](stories/schema-dumper-mysql-expression-index-dump.md)                     | Emit MySQL 8 expression-index schema dump syntax and converge gate                    | ready       | null    | —            |
| [transaction-isolation-level-generic-dual-connection](stories/transaction-isolation-level-generic-dual-connection.md) | Converge transaction-isolation-level tests to generic dual connections                | ready       | null    | —            |
| [view-insert-mysql-no-auto-value-on-zero](stories/view-insert-mysql-no-auto-value-on-zero.md)                         | Fix MySQL updatable-view insert auto-assigned primary key                             | ready       | null    | —            |
| [gate-residual-mismatch-burndown](stories/gate-residual-mismatch-burndown.md)                                         | gate-residual-mismatch-burndown                                                       | claimed     | null    | —            |
| [adapter-advisory-locks-generic-construction](stories/adapter-advisory-locks-generic-construction.md)                 | Converge advisory_locks enabled test to generic adapter construction                  | in-progress | null    | —            |
| [gate-wrong-gate-body-convergence](stories/gate-wrong-gate-body-convergence.md)                                       | gate-wrong-gate-body-convergence                                                      | in-progress | null    | —            |
