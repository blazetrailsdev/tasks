...
| [bulk-alter-default-functions-mariadb-uuid-branch](stories/bulk-alter-default-functions-mariadb-uuid-branch.md)       | Add UUID() else-branch to bulk_alter default-functions test for MariaDB               | claimed | 15      | —            |
