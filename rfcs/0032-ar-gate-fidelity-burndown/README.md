...
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ----------- | ------- | ------------ |
| [gate-extractor-compound-if-positive-adapter](stories/gate-extractor-compound-if-positive-adapter.md)     | Gate extractor: capture positive current_adapter? in compound conjunction conditions  | ready       | 120     | —            |
