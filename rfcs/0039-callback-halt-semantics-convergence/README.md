...
| ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------- | ------- | ------- |
| [model-callbacks-block-false-after-skip-fidelity](stories/model-callbacks-block-false-after-skip-fidelity.md) | ModelCallbacks: after callbacks skipped when block returns false (Rails fidelity gap) | ready   | 120     | —       |
