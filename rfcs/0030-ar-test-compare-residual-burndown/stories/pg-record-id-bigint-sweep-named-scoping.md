---
title: "pg-record-id-bigint-sweep-named-scoping"
status: in-progress
updated: 2026-06-21
...
priority: null
pr: 3806
claim: "2026-06-21T17:10:41Z"
assignee: "pg-record-id-bigint-sweep-named-scoping"
blocked-by: null
---
...
Enumerated hit(s) in `packages/activerecord/src/scoping/named-scoping.test.ts`:

- line 40: `sortedIds = ids(rows).sort((a, b) => a - b)`
...
- [ ] Converge each id-arithmetic / `record.id` assertion in `packages/activerecord/src/scoping/named-scoping.test.ts` to be green
