...
| [eager-joined-includes-multi-fanout-coverage](stories/eager-joined-includes-multi-fanout-coverage.md)                         | eager_test: regression coverage for multi-include joins∩includes fan-out                                  | claimed     | 40      | —                |
