...
| [schema-dumper-expression-default-pg-sqlite](stories/schema-dumper-expression-default-pg-sqlite.md)                           | Schema dumper reflects PG/SQLite expression-column defaults                                               | in-progress | 100     | —                |
| [subselect-full-record-equality-assertion](stories/subselect-full-record-equality-assertion.md)                               | subselect test: assert full-record equality to match Rails assert_equal (not id-only)                     | in-progress | 20      | —                |
