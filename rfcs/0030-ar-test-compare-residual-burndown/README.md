...
| [a1-eager-scope-stack-exclusive-scope](stories/a1-eager-scope-stack-exclusive-scope.md)                                       | A1h — eager_test: scope-stack + exclusive/default scope preload                                           | claimed     | null    | associations     |
| [cascaded-eager-join-alias-and-callbacks](stories/cascaded-eager-join-alias-and-callbacks.md)                                 | cascaded-eager-join-alias-and-callbacks                                                                   | claimed     | null    | —                |
...
| [a1-eager-count-multitable-conditional](stories/a1-eager-count-multitable-conditional.md)                                     | A1d — eager_test: count/size with multi-table conditional                                                 | in-progress | null    | associations     |
| [a1-eager-cpk-preload](stories/a1-eager-cpk-preload.md)                                                                       | A1g — eager_test: preload via composite query_constraints / CPK                                           | in-progress | null    | associations     |
| [a1-eager-joined-table-conditions-order](stories/a1-eager-joined-table-conditions-order.md)                                   | A1b — eager_test: conditions/order/select/limit on joined tables                                          | in-progress | null    | associations     |
| [a1-eager-misc-notifications-too-many-ids](stories/a1-eager-misc-notifications-too-many-ids.md)                               | A1i — eager_test: notifications/i18n, too-many-ids, preload SQL, pk has_one                               | in-progress | null    | associations     |
| [a1-eager-polymorphic-references-existential](stories/a1-eager-polymorphic-references-existential.md)                         | A1f — eager_test: polymorphic custom-type/existential/references                                          | in-progress | null    | associations     |
| [a1-eager-sti-through](stories/a1-eager-sti-through.md)                                                                       | A1e — eager_test: preload/eager-load through STI join models                                              | in-progress | null    | associations     |
| [a1-eager-where-references-and-from](stories/a1-eager-where-references-and-from.md)                                           | A1c — eager_test: where/from references association name + implicit references                            | in-progress | null    | associations     |
