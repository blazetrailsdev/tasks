...
| [pg-bigint-assoc-key-match-through-inverse-impl](stories/pg-bigint-assoc-key-match-through-inverse-impl.md)                           | Converge association/through/inverse key-match for BigInt PK vs number FK (flip blocker)                  | claimed     | 200     | —                |
| [pg-bigserial-assertion-sweep-hasmany-hasone](stories/pg-bigserial-assertion-sweep-hasmany-hasone.md)                                 | Converge BigInt PK assertions: has-many/has-one/through + small assoc files (flip prereq)                 | claimed     | 180     | —                |
| [pg-bigserial-assertion-sweep-belongs-to](stories/pg-bigserial-assertion-sweep-belongs-to.md)                                         | Converge BigInt PK assertions: belongs-to-associations (flip prereq)                                      | in-progress | 120     | —                |
