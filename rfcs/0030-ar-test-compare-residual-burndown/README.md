...
| [cc-id-setter-missing-attribute](stories/cc-id-setter-missing-attribute.md)                                     | cc-id-setter-missing-attribute                                                                            | ready       | null    | —                |
...
| [c1-schema-dumper-residual-gaps](stories/c1-schema-dumper-residual-gaps.md)                                     | c1-schema-dumper-residual-gaps                                                                            | claimed     | null    | —                |
| [c3-primary-keys](stories/c3-primary-keys.md)                                                                   | C3 — primary_keys residuals                                                                               | claimed     | 70      | core-residuals   |
| [c4-migration-column-def-tail](stories/c4-migration-column-def-tail.md)                                         | C4 — migration + column_definition + invertible tail                                                      | claimed     | 60      | core-residuals   |
| [associations-test-canonical-fixtures-convergence](stories/associations-test-canonical-fixtures-convergence.md) | Convert associations.test bespoke models to canonical fixtures (subselect/references/limitable)           | in-progress | 200     | associations     |
| [autosave-has-many-save-on-parent](stories/autosave-has-many-save-on-parent.md)                                 | Autosave persists built has_many children on owner save                                                   | in-progress | 120     | associations     |
| [b2-default-scoping](stories/b2-default-scoping.md)                                                             | B2 — default_scoping parity                                                                               | in-progress | 130     | relation-scoping |
...
| [b3-relation-select-joins](stories/b3-relation-select-joins.md)                                                 | B3 — relation select + multi-join table aliasing                                                          | in-progress | 140     | relation-scoping |
