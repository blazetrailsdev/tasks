...
| [current-savepoint-name-accessor](stories/current-savepoint-name-accessor.md)                                   | expose current_savepoint_name / Transaction#savepoint_name                                                | ready       | 50      | —                |
...
| [d1-transactions-commit-destroy-callbacks](stories/d1-transactions-commit-destroy-callbacks.md)                 | D1 — transactions: committed/destroy callback firing                                                      | in-progress | 330     | persistence      |
