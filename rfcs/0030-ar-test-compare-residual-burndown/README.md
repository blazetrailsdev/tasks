...
| [strict-loading-new-record-gate-in-loaders](stories/strict-loading-new-record-gate-in-loaders.md)                     | Gate strict-loading violation behind find_target? new-record check in functional loaders                  | claimed     | 80      | —                |
...
| [raw-connection-materializes-transactions](stories/raw-connection-materializes-transactions.md)                       | rawConnection materializes txn + disables lazy transactions                                               | in-progress | 90      | —                |
