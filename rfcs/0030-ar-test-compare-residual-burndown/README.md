...
| [eager-load-walk-dedup-through-intermediate](stories/eager-load-walk-dedup-through-intermediate.md)                                   | Walk-dedup through-association intermediate join table against eager spec                                 | ready   | 50      | —                |
...
| [djar-disable-joins-bigint-key-match-reorder](stories/djar-disable-joins-bigint-key-match-reorder.md)                                 | Converge DisableJoinsAssociationRelation reorder + inverse find() key-match for BigInt PK vs number FK    | claimed | 120     | —                |
