...
| [d2-insert-all-canonical-models](stories/d2-insert-all-canonical-models.md)                                     | insert-all.test.ts: migrate to canonical models + fixtures                                                | claimed     | 200     | persistence      |
