...
| [a1-eager-joined-table-conditions-order](stories/a1-eager-joined-table-conditions-order.md)                                   | A1b — eager_test: conditions/order/select/limit on joined tables                                          | claimed     | null    | associations     |
