...
| [insert-all-returning-alias-resolution](stories/insert-all-returning-alias-resolution.md)                             | insert_all RETURNING does not resolve aliased attributes                                                  | claimed     | 60      | persistence      |
...
| [insert-all-sti-type-injection](stories/insert-all-sti-type-injection.md)                                             | insert_all resolveSti ignores registerSubclass STI                                                        | in-progress | 80      | persistence      |
