...
| [autosave-uniqueness-rollback-and-error-format](stories/autosave-uniqueness-rollback-and-error-format.md)             | Un-skip autosave uniqueness-rollback tests (validates uniqueness routing + propagateErrors convergence)   | draft       | 120     | —                |
...
| [cascaded-eager-nil-and-proxy-preload-convergence](stories/cascaded-eager-nil-and-proxy-preload-convergence.md)       | cascaded-eager-nil-and-proxy-preload-convergence                                                          | draft       | null    | —                |
...
| [reload-association-cache-through-join-pg-cast](stories/reload-association-cache-through-join-pg-cast.md)             | Un-skip reload-association-cache (PG through-JOIN type-cast + publication callback fix)                   | draft       | 80      | —                |
| [store-full-sti-class-name](stories/store-full-sti-class-name.md)                                                     | store-full-sti-class-name                                                                                 | draft       | null    | —                |
| [d2-insert-all-db-primary-keys-convergence](stories/d2-insert-all-db-primary-keys-convergence.md)                     | d2-insert-all-db-primary-keys-convergence                                                                 | ready       | null    | —                |
...
| [insert-all-returning-alias-resolution](stories/insert-all-returning-alias-resolution.md)                             | insert_all RETURNING does not resolve aliased attributes                                                  | ready       | 60      | persistence      |
| [insert-all-sti-type-injection](stories/insert-all-sti-type-injection.md)                                             | insert_all resolveSti ignores registerSubclass STI                                                        | ready       | 80      | persistence      |
| [insert-all-timestamp-alias-case](stories/insert-all-timestamp-alias-case.md)                                         | insert_all timestamp-alias resolution is snake_case-only                                                  | ready       | 60      | persistence      |
| [legacy-migration-5-0-uuid-default](stories/legacy-migration-5-0-uuid-default.md)                                     | Legacy Migration[5.0] uuid PK default (uuid_generate_v4) via migrator                                     | ready       | 200     | adapter          |
...
| [model-loadschema-nil-primary-key-from-introspection](stories/model-loadschema-nil-primary-key-from-introspection.md) | loadSchema consults adapter.primaryKey so key-less data sources yield nil PK                              | ready       | 120     | adapter          |
...
| [pg-array-oid-element-subtypes](stories/pg-array-oid-element-subtypes.md)                                             | PG array OID element subtypes: hstore[] / tz-aware datetime[] / timestamp[] precision                     | ready       | 180     | adapter          |
...
| [pg-ddl-exec-exception-translation](stories/pg-ddl-exec-exception-translation.md)                                     | PG DDL exec() path: translate driver errors to StatementInvalid                                           | ready       | 120     | adapter          |
| [pg-record-id-bigint-assertion-sweep](stories/pg-record-id-bigint-assertion-sweep.md)                                 | Sweep PG-lane record.id assertions to tolerate BigInt (pre-BIGSERIAL-flip)                                | ready       | 200     | —                |
| [pg-untyped-pk-int8-deserialization](stories/pg-untyped-pk-int8-deserialization.md)                                   | PG untyped-PK int8 deserialization: resolve implicit PK type on schema-cache miss                         | ready       | 120     | —                |
| [preload-eager-inverse-before-callbacks](stories/preload-eager-inverse-before-callbacks.md)                           | Wire inverse_of before callbacks on preloader + join-dependency eager paths                               | ready       | 180     | —                |
...
| [raw-connection-materializes-transactions](stories/raw-connection-materializes-transactions.md)                       | rawConnection materializes txn + disables lazy transactions                                               | ready       | 90      | —                |
...
| [schema-dumper-emittable-virtual-column-options](stories/schema-dumper-emittable-virtual-column-options.md)           | SchemaDumper emitTable routes virtual columns through PG prepareColumnOptions                             | ready       | 90      | adapter          |
...
| [transaction-option-validation-and-ddl](stories/transaction-option-validation-and-ddl.md)                             | transaction() option-key validation + DDL-in-transaction                                                  | ready       | 80      | —                |
...
| [with-connection-query-path](stories/with-connection-query-path.md)                                                   | with-connection-query-path                                                                                | ready       | null    | —                |
| [has-many-current-scope-isolation](stories/has-many-current-scope-isolation.md)                                       | has_many reads ignore class current_scope                                                                 | claimed     | 70      | relation-scoping |
| [c1-schema-dumper-parity](stories/c1-schema-dumper-parity.md)                                                         | C1 — schema_dumper parity                                                                                 | in-progress | 180     | unblockers       |
| [d2-insert-all-returning-result](stories/d2-insert-all-returning-result.md)                                           | insert_all/upsert_all returning → ActiveRecord::Result                                                    | in-progress | 200     | persistence      |
| [inverse-of-single-association-access-convergence](stories/inverse-of-single-association-access-convergence.md)       | Inverse-of wiring on single-association access path (recursive/STI/callbacks/autosave)                    | in-progress | 200     | associations     |
| [left-joins-cross-model-merge](stories/left-joins-cross-model-merge.md)                                               | left_joins cross-model merge preserves left joins + wheres                                                | in-progress | 120     | associations     |
| [old-config-first-saved-commit-callbacks](stories/old-config-first-saved-commit-callbacks.md)                         | old-config first-saved-instance commit callbacks + before_commit order                                    | in-progress | 90      | —                |
| [pool-eviction-on-transaction-raise](stories/pool-eviction-on-transaction-raise.md)                                   | pool evicts connection on begin/commit/rollback failure                                                   | in-progress | 90      | —                |
| [touch-transactional-callbacks](stories/touch-transactional-callbacks.md)                                             | touch enrolls in transactional commit/rollback callbacks                                                  | in-progress | 120     | —                |
| [update-delete-all-default-scope-joins](stories/update-delete-all-default-scope-joins.md)                             | update_all/delete_all preserve default-scope JOIN via subquery                                            | in-progress | 90      | relation-scoping |
