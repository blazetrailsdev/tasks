...
| [associations-test-canonical-fixtures-convergence](stories/associations-test-canonical-fixtures-convergence.md) | Convert associations.test bespoke models to canonical fixtures (subselect/references/limitable)           | ready       | 200     | associations     |
