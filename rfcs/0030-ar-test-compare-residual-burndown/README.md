...
| ------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | ----------- | ------- | ---------------- |
| [pg-find-bigint-bind-serialization](stories/pg-find-bigint-bind-serialization.md)                                                     | PG bigserial: find(BigInt) bind serialization throws under flip                                           | draft       | 60      | —                |
...
| [pg-bigint-belongs-to-stalestate-composite-key-serialize](stories/pg-bigint-belongs-to-stalestate-composite-key-serialize.md)         | Normalize BigInt in BelongsToAssociation#staleState composite-FK JSON.stringify                           | ready       | 30      | —                |
| [pg-bigint-number-key-match-inmemory-association-audit](stories/pg-bigint-number-key-match-inmemory-association-audit.md)             | Audit non-preloader in-memory association matching for BigInt-PK/number-FK key mismatch                   | ready       | 120     | —                |
...
| [has-one-destroy-callback-inverse-sync-convergence](stories/has-one-destroy-callback-inverse-sync-convergence.md)                     | has-one-destroy-callback-inverse-sync-convergence                                                         | in-progress | null    | —                |
...
| [association-scope-result-caching-and-comments-newest](stories/association-scope-result-caching-and-comments-newest.md)               | Association scope-result caching on proxies + Post comments newest extension                              | done        | 150     | —                |
...
| [canonical-company-enable-sti](stories/canonical-company-enable-sti.md)                                                               | canonical-company-enable-sti                                                                              | done        | null    | —                |
| [cascaded-eager-join-alias-and-callbacks](stories/cascaded-eager-join-alias-and-callbacks.md)                                         | cascaded-eager-join-alias-and-callbacks                                                                   | done        | null    | —                |
| [cascaded-eager-join-emit-alias](stories/cascaded-eager-join-emit-alias.md)                                                           | cascaded-eager-join-emit-alias                                                                            | done        | null    | —                |
...
| [collection-proxy-named-scope-relation-cache](stories/collection-proxy-named-scope-relation-cache.md)                                 | Cache named-scope relations on association proxy + invalidate on reset                                    | done        | 120     | —                |
...
| [compute-type-namespace-relative-resolution](stories/compute-type-namespace-relative-resolution.md)                                   | compute-type-namespace-relative-resolution                                                                | done        | null    | —                |
...
| [djar-disable-joins-bigint-key-match-reorder](stories/djar-disable-joins-bigint-key-match-reorder.md)                                 | Converge DisableJoinsAssociationRelation reorder + inverse find() key-match for BigInt PK vs number FK    | done        | 120     | —                |
...
| [eager-joined-includes-multi-fanout-coverage](stories/eager-joined-includes-multi-fanout-coverage.md)                                 | eager_test: regression coverage for multi-include joins∩includes fan-out                                  | done        | 40      | —                |
...
| [eager-load-joins-walk-dedup](stories/eager-load-joins-walk-dedup.md)                                                                 | eager-load-joins-walk-dedup                                                                               | done        | null    | —                |
| [eager-load-joins-walk-dedup-nested-hash](stories/eager-load-joins-walk-dedup-nested-hash.md)                                         | eager-load-joins-walk-dedup-nested-hash                                                                   | done        | null    | —                |
| [eager-load-too-many-ids-join-dependency-perf](stories/eager-load-too-many-ids-join-dependency-perf.md)                               | JoinDependency instantiation perf: un-skip eager_load too-many-ids on MySQL-family lanes                  | done        | 150     | —                |
| [eager-load-walk-dedup-through-intermediate](stories/eager-load-walk-dedup-through-intermediate.md)                                   | Walk-dedup through-association intermediate join table against eager spec                                 | done        | 50      | —                |
| [findsti-namespace-relative-fallback](stories/findsti-namespace-relative-fallback.md)                                                 | findsti-namespace-relative-fallback                                                                       | done        | null    | —                |
...
| [legacy-migration-5-0-create-table-and-chain](stories/legacy-migration-5-0-create-table-and-chain.md)                                 | legacy-migration-5-0-create-table-and-chain                                                               | done        | null    | —                |
...
| [pg-bigint-assoc-key-match-through-inverse-impl](stories/pg-bigint-assoc-key-match-through-inverse-impl.md)                           | Converge association/through/inverse key-match for BigInt PK vs number FK (flip blocker)                  | done        | 200     | —                |
| [pg-bigint-pk-number-fk-association-key-match](stories/pg-bigint-pk-number-fk-association-key-match.md)                               | pg-bigint-pk-number-fk-association-key-match                                                              | done        | null    | —                |
| [pg-bigserial-assertion-sweep-belongs-to](stories/pg-bigserial-assertion-sweep-belongs-to.md)                                         | Converge BigInt PK assertions: belongs-to-associations (flip prereq)                                      | done        | 120     | —                |
| [pg-bigserial-assertion-sweep-bind-autosave-nullrel-reserved](stories/pg-bigserial-assertion-sweep-bind-autosave-nullrel-reserved.md) | Converge BigInt PK assertions: bind-parameter/autosave/null-relation/reserved-word (flip prereq)          | done        | 90      | —                |
| [pg-bigserial-assertion-sweep-hasmany-hasone](stories/pg-bigserial-assertion-sweep-hasmany-hasone.md)                                 | Converge BigInt PK assertions: has-many/has-one/through + small assoc files (flip prereq)                 | done        | 180     | —                |
| [pg-bigserial-assertion-sweep-querycache-associations](stories/pg-bigserial-assertion-sweep-querycache-associations.md)               | Converge BigInt PK assertions: query-cache + associations (flip prereq)                                   | done        | 120     | —                |
| [pg-bigserial-assertion-sweep-relation-fixtures-tail](stories/pg-bigserial-assertion-sweep-relation-fixtures-tail.md)                 | Converge BigInt PK assertions: relation/fixtures/adapter tail (flip prereq)                               | done        | 80      | —                |
| [pg-bigserial-assertion-sweep-tail](stories/pg-bigserial-assertion-sweep-tail.md)                                                     | Converge BigInt PK assertions: long-tail 10 files (flip prereq)                                           | done        | 90      | —                |
| [pg-bigserial-createtable-dumper-flip](stories/pg-bigserial-createtable-dumper-flip.md)                                               | Flip PG default PK to BIGSERIAL: createTable + dumper + un-skip                                           | done        | 60      | —                |
...
| [pg-record-id-bigint-sweep-residual-55](stories/pg-record-id-bigint-sweep-residual-55.md)                                             | pg-record-id-bigint-sweep-residual-55                                                                     | done        | null    | —                |
