...
| [model-loadschema-nil-primary-key-from-introspection](stories/model-loadschema-nil-primary-key-from-introspection.md) | loadSchema consults adapter.primaryKey so key-less data sources yield nil PK                              | claimed     | 120     | adapter          |
