...
| [insert-all-log-message-model-name](stories/insert-all-log-message-model-name.md)                                             | insert_all/upsert_all log message includes model name (SQL-log capture)                                   | claimed     | 80      | persistence      |
