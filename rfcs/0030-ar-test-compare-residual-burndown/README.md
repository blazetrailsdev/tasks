...
| [habtm-collection-proxy-find](stories/habtm-collection-proxy-find.md)                                                 | habtm: CollectionProxy include/transaction/preloaded-size                                                 | ready       | 120     | associations     |
...
| [async-validations-honor-validation-context](stories/async-validations-honor-validation-context.md)                   | async-validations-honor-validation-context                                                                | in-progress | null    | —                |
| [autosave-uniqueness-rollback-and-error-format](stories/autosave-uniqueness-rollback-and-error-format.md)             | Un-skip autosave uniqueness-rollback tests (validates uniqueness routing + propagateErrors convergence)   | in-progress | 120     | —                |
| [canonical-bulb-public-attribute-accessors](stories/canonical-bulb-public-attribute-accessors.md)                     | canonical-bulb-public-attribute-accessors                                                                 | in-progress | null    | —                |
