...
| [schema-dumper-pg-infinity-float-default](stories/schema-dumper-pg-infinity-float-default.md)                                 | PG float infinity/NaN column default schema dump                                                          | claimed     | 60      | —                |
| [unskip-named-scoping-query-cache-on-associations](stories/unskip-named-scoping-query-cache-on-associations.md)               | Un-skip named-scoping query-cache-on-associations cases                                                   | claimed     | 150     | core-residuals   |
