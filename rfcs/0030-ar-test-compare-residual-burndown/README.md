...
| [cascaded-eager-nil-and-proxy-preload-convergence](stories/cascaded-eager-nil-and-proxy-preload-convergence.md)               | cascaded-eager-nil-and-proxy-preload-convergence                                                          | claimed     | null    | —                |
| [habtm-namespaced-classname](stories/habtm-namespaced-classname.md)                                                           | habtm: namespaced/symbol className resolution                                                             | claimed     | 100     | associations     |
| [habtm-residual-features](stories/habtm-residual-features.md)                                                                 | habtm: polymorphic-through, alternate-db, belongs_to-required                                             | claimed     | 150     | associations     |
