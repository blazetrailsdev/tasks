...
| [collection-proxy-named-scope-relation-cache](stories/collection-proxy-named-scope-relation-cache.md)                         | Cache named-scope relations on association proxy + invalidate on reset                                    | claimed     | 120     | —                |
