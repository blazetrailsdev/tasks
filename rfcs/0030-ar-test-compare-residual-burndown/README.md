...
| [insert-all-serialize-array-name-consistency](stories/insert-all-serialize-array-name-consistency.md)                         | insert_all serialize round-trip consistency (RETURNING)                                                   | in-progress | 40      | persistence      |
