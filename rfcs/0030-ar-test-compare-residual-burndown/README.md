...
| [schema-dumper-emittable-virtual-column-options](stories/schema-dumper-emittable-virtual-column-options.md)           | SchemaDumper emitTable routes virtual columns through PG prepareColumnOptions                             | claimed     | 90      | adapter          |
...
| [reverse-single-term-balanced-paren-order](stories/reverse-single-term-balanced-paren-order.md)                       | reverse-single-term-balanced-paren-order                                                                  | in-progress | null    | —                |
