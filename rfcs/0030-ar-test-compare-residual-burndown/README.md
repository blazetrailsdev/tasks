...
| [a1-eager-preloader-semantics](stories/a1-eager-preloader-semantics.md)                                       | A1 — eager_test: preloader eager-loading semantics                                                        | in-progress | 470     | associations     |
| [a4-habtm-join-aliasing](stories/a4-habtm-join-aliasing.md)                                                   | A4 — habtm: alias intermediate join table                                                                 | in-progress | 100     | associations     |
| [a5-cascaded-and-sti-eager](stories/a5-cascaded-and-sti-eager.md)                                             | A5 — cascaded eager + nested-include + full-STI-class                                                     | in-progress | 140     | associations     |
