...
| [subselect-full-record-equality-assertion](stories/subselect-full-record-equality-assertion.md)                               | subselect test: assert full-record equality to match Rails assert_equal (not id-only)                     | claimed     | 20      | —                |
