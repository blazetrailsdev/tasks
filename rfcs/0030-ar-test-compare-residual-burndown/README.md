...
| [djar-disable-joins-bigint-key-match-reorder](stories/djar-disable-joins-bigint-key-match-reorder.md)                                 | Converge DisableJoinsAssociationRelation reorder + inverse find() key-match for BigInt PK vs number FK    | ready   | 120     | —                |
