...
| [virtual-reconcile-warm-schema-cache](stories/virtual-reconcile-warm-schema-cache.md)                                 | Memoize schema cache when virtual reconciliation reflects on cold cache                                   | in-progress | 40      | core-residuals   |
| [where-hash-keys-resolve-to-join-alias](stories/where-hash-keys-resolve-to-join-alias.md)                             | where-hash-keys-resolve-to-join-alias                                                                     | in-progress | null    | —                |
| [with-connection-query-path](stories/with-connection-query-path.md)                                                   | with-connection-query-path                                                                                | in-progress | null    | —                |
