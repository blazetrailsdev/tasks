...
| [b2-unscope-leftjoins-alias](stories/b2-unscope-leftjoins-alias.md)                                             | unscope accepts leftJoins alias                                                                           | ready       | 20      | —                |
| [b2-unscope-where-merge-reset](stories/b2-unscope-where-merge-reset.md)                                         | merge of unscope(where) clears where clause                                                               | ready       | 40      | —                |
...
| [b2-sti-hasmany-preload-foreign-key](stories/b2-sti-hasmany-preload-foreign-key.md)                             | STI hasMany eager/preload foreign key derivation                                                          | claimed     | 50      | —                |
| [b2-sti-type-survives-unscope](stories/b2-sti-type-survives-unscope.md)                                         | STI type predicate survives unscope(where)                                                                | claimed     | 50      | —                |
| [a6-inverse-and-association-tail](stories/a6-inverse-and-association-tail.md)                                   | A6 — inverse-of + bidirectional + collection tail                                                         | in-progress | 140     | associations     |
...
| [b1-relation-scoping](stories/b1-relation-scoping.md)                                                           | B1 — relation_scoping parity                                                                              | in-progress | 160     | relation-scoping |
| [b2-counter-cache-column-from-belongsto](stories/b2-counter-cache-column-from-belongsto.md)                     | counter-cache column derives from belongs_to                                                              | in-progress | 50      | —                |
| [b2-createwith-merge-precedence](stories/b2-createwith-merge-precedence.md)                                     | createWith merge precedence (last-wins)                                                                   | in-progress | 40      | —                |
| [b2-default-scoping](stories/b2-default-scoping.md)                                                             | B2 — default_scoping parity                                                                               | in-progress | 130     | relation-scoping |
| [b2-reverse-multicolumn-string-order](stories/b2-reverse-multicolumn-string-order.md)                           | reverseOrder handles multi-column string order                                                            | in-progress | 40      | —                |
