...
| [collection-proxy-named-scope-relation-cache](stories/collection-proxy-named-scope-relation-cache.md)                         | Cache named-scope relations on association proxy + invalidate on reset                                    | in-progress | 120     | —                |
| [compute-type-namespace-relative-resolution](stories/compute-type-namespace-relative-resolution.md)                           | compute-type-namespace-relative-resolution                                                                | in-progress | null    | —                |
