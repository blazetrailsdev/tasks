...
| [d2-insert-all-db-primary-keys-convergence](stories/d2-insert-all-db-primary-keys-convergence.md)                     | d2-insert-all-db-primary-keys-convergence                                                                 | in-progress | null    | —                |
...
| [insert-all-returning-alias-resolution](stories/insert-all-returning-alias-resolution.md)                             | insert_all RETURNING does not resolve aliased attributes                                                  | in-progress | 60      | persistence      |
...
| [insert-all-timestamp-alias-case](stories/insert-all-timestamp-alias-case.md)                                         | insert_all timestamp-alias resolution is snake_case-only                                                  | in-progress | 60      | persistence      |
