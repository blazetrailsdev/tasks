...
| [change-table-recorder-adapter-column-methods](stories/change-table-recorder-adapter-column-methods.md)               | change_table recorder proxy surfaces adapter column-type shorthands (t.hstore)                            | ready       | 60      | adapter          |
