...
| [associations-test-canonical-fixtures-convergence](stories/associations-test-canonical-fixtures-convergence.md) | Convert associations.test bespoke models to canonical fixtures (subselect/references/limitable)           | claimed     | 200     | associations     |
...
| [b2-unscope-leftjoins-alias](stories/b2-unscope-leftjoins-alias.md)                                             | unscope accepts leftJoins alias                                                                           | in-progress | 20      | —                |
