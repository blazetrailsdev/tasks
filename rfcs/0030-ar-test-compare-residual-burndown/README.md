...
| [pg-bigserial-assertion-sweep-querycache-associations](stories/pg-bigserial-assertion-sweep-querycache-associations.md)               | Converge BigInt PK assertions: query-cache + associations (flip prereq)                                   | claimed     | 120     | —                |
| [pg-bigserial-assertion-sweep-tail](stories/pg-bigserial-assertion-sweep-tail.md)                                                     | Converge BigInt PK assertions: long-tail 10 files (flip prereq)                                           | claimed     | 90      | —                |
| [pg-bigserial-assertion-sweep-bind-autosave-nullrel-reserved](stories/pg-bigserial-assertion-sweep-bind-autosave-nullrel-reserved.md) | Converge BigInt PK assertions: bind-parameter/autosave/null-relation/reserved-word (flip prereq)          | in-progress | 90      | —                |
