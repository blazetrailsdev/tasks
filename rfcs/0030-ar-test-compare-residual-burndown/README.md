...
| [pg-bigserial-assertion-sweep-relation-fixtures-tail](stories/pg-bigserial-assertion-sweep-relation-fixtures-tail.md)                 | Converge BigInt PK assertions: relation/fixtures/adapter tail (flip prereq)                               | ready       | 80      | —                |
...
| [pg-bigserial-assertion-sweep-hasmany-hasone](stories/pg-bigserial-assertion-sweep-hasmany-hasone.md)                                 | Converge BigInt PK assertions: has-many/has-one/through + small assoc files (flip prereq)                 | in-progress | 180     | —                |
