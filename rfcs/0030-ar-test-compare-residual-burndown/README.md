...
| [cascaded-eager-nil-and-proxy-preload-convergence](stories/cascaded-eager-nil-and-proxy-preload-convergence.md)               | cascaded-eager-nil-and-proxy-preload-convergence                                                          | in-progress | null    | —                |
| [habtm-namespaced-classname](stories/habtm-namespaced-classname.md)                                                           | habtm: namespaced/symbol className resolution                                                             | in-progress | 100     | associations     |
| [habtm-residual-features](stories/habtm-residual-features.md)                                                                 | habtm: polymorphic-through, alternate-db, belongs_to-required                                             | in-progress | 150     | associations     |
| [habtm-savepoint-lifecycle](stories/habtm-savepoint-lifecycle.md)                                                             | habtm: assign_ids savepoint lifecycle on PG/MySQL                                                         | in-progress | 80      | associations     |
| [isvalid-does-not-run-uniqueness-validations](stories/isvalid-does-not-run-uniqueness-validations.md)                         | isvalid-does-not-run-uniqueness-validations                                                               | in-progress | null    | —                |
