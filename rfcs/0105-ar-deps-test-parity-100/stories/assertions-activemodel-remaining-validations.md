...
| --------------------------------------------- | ----: | ---: | ----: |
| `validations/conditional_validation_test.rb`  |    14 |   14 |     0 |
...
| `validations/presence_validation_test.rb`     |     5 |    7 |     0 |
| `validations/absence_validation_test.rb`      |     4 |    5 |     0 |
| `validations/validations_context_test.rb`     |     4 |    5 |     0 |

**182 divergences** (72 assertion-count, 108 assertion-kind, 2
