---
title: "Port the migration constraint and residue cases (8 missing)"
status: done
updated: 2026-08-30
...
This story covers **8 missing tests**:

- `vendor/rails/activerecord/test/cases/migration/unique_constraint_test.rb` — 3 missing
- `vendor/rails/activerecord/test/cases/migration/exclusion_constraint_test.rb` — 3 missing
- `vendor/rails/activerecord/test/cases/migration/pending_migrations_test.rb` — 1 missing
- `vendor/rails/activerecord/test/cases/migration/logger_test.rb` — 1 missing
