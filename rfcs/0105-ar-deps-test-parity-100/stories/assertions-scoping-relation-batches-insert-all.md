...
| --------------------------------------------------------------- | ----: | ---: | ----: |
| `scoping/named_scoping_test.rb`                                 |    14 |   48 |     0 |
| `batches_test.rb`                                               |    23 |   39 |     0 |
| `relation_test.rb`                                              |    16 |   34 |     0 |
| `insert_all_test.rb`                                            |     6 |   35 |     0 |
| `scoping/relation_scoping_test.rb`                              |     6 |   19 |     0 |
| `scoping/default_scoping_test.rb`                               |     6 |    9 |     0 |

**255 divergences** (71 assertion-count, 184 assertion-kind, 0
