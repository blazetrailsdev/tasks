...
| ------------------------------------------------------------------ | ----: | ---: | ----: |
| `associations/has_many_through_associations_test.rb`               |    35 |   79 |     0 |
| `associations/has_many_through_disable_joins_associations_test.rb` |    26 |   15 |     0 |
| `associations/join_model_test.rb`                                  |     9 |   28 |     0 |

**192 divergences** (70 assertion-count, 122 assertion-kind, 0
