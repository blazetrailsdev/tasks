...
This story covers **18 missing tests**:

- `vendor/rails/activerecord/test/cases/migration/column_attributes_test.rb` — 11 missing
- `vendor/rails/activerecord/test/cases/migration/column_positioning_test.rb` — 7 missing
