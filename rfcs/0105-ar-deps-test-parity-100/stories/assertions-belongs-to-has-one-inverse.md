...
| --------------------------------------------------------------- | ----: | ---: | ----: |
| `associations/belongs_to_associations_test.rb`                  |    31 |   71 |     0 |
| `associations/inverse_associations_test.rb`                     |    17 |   51 |     2 |
| `associations/has_one_associations_test.rb`                     |     7 |   29 |     0 |
| `associations/has_one_through_associations_test.rb`             |     3 |   14 |     0 |

**225 divergences** (58 assertion-count, 165 assertion-kind, 2
