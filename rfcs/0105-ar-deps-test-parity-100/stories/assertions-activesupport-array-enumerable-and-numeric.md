...
| ---------------------------------------- | ----: | ---: | ----: |
| `core_ext/range_ext_test.rb`             |     3 |   38 |     0 |
| `core_ext/enumerable_test.rb`            |    14 |   15 |     2 |
| `core_ext/numeric_ext_test.rb`           |    11 |   11 |     0 |
| `core_ext/array/conversions_test.rb`     |     8 |   10 |     2 |
| `core_ext/array/grouping_test.rb`        |     9 |    9 |     0 |
| `core_ext/array/extract_test.rb`         |     3 |    3 |     0 |
| `core_ext/integer_ext_test.rb`           |     3 |    3 |     0 |
| `core_ext/array/access_test.rb`          |     2 |    2 |     0 |
| `core_ext/array/extract_options_test.rb` |     2 |    2 |     0 |
| `core_ext/array/wrap_test.rb`            |     0 |    2 |     0 |

**154 divergences** (55 assertion-count, 95 assertion-kind, 4
