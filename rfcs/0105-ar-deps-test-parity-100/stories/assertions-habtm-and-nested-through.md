...
| --------------------------------------------------------------- | ----: | ---: | ----: |
| `associations/nested_through_associations_test.rb`              |    19 |   26 |     0 |
| `associations/has_and_belongs_to_many_associations_test.rb`     |    10 |   33 |     0 |

**88 divergences** (29 assertion-count, 59 assertion-kind, 0
