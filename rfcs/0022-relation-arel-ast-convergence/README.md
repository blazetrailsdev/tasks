...
| [relation-tosql-unprepared-statement](stories/relation-tosql-unprepared-statement.md)                                   | Relation#toSql via unprepared_statement { conn.to_sql(arel) } (drop the post-hoc substituteBoundValues inliner)       | claimed     | 120     | set-ops |
