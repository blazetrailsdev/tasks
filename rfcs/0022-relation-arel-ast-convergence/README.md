...
| [build-joins-emit-single-construct-join-dependency](stories/build-joins-emit-single-construct-join-dependency.md)                 | Converge emitJoinPlan to Rails' single construct_join_dependency(named_joins, join_type) shape                                  | claimed | 120     | —       |
