...
| [relation-handler-distinct-pk-load-time-materialization](stories/relation-handler-distinct-pk-load-time-materialization.md)       | Load-time deferred distinct-PK materialization for eager+limit/offset where-subqueries (MySQL IN-list parity)         | claimed | 350     | set-ops |
