...
| [relation-handler-distinct-pk-materialization](stories/relation-handler-distinct-pk-materialization.md)                     | RelationHandler: live eager-loading apply_join_dependency + Rails-faithful distinctRelationForPrimaryKey (sync slice) | claimed | 220     | set-ops |
