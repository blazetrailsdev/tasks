...
| [compile-arel-node-bind-threading](stories/compile-arel-node-bind-threading.md)                                         | Thread \_compileArelNode embedded binds through the outer collector (drop text inlining)                              | claimed     | 250     | set-ops |
