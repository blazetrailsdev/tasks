...
| [where-clause-tosql-via-arel](stories/where-clause-tosql-via-arel.md)                                                       | Build WhereClause SQL through Arel AST instead of bespoke toSql (burn down rails-arel-tosql exclude)                  | claimed | 120     | —       |
