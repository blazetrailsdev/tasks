...
| [remove-tosql-connectionless-fallback](stories/remove-tosql-connectionless-fallback.md)                                 | Remove Relation#toSql connectionless fallback (resolve a connection like model.with_connection)                       | draft       | 80      | set-ops |
...
| [relation-tosql-unprepared-statement](stories/relation-tosql-unprepared-statement.md)                                   | Relation#toSql via unprepared_statement { conn.to_sql(arel) } (drop the post-hoc substituteBoundValues inliner)       | in-progress | 120     | set-ops |
