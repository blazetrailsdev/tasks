...
| [using-limitable-reflections-joins-leftjoins-convergence](stories/using-limitable-reflections-joins-leftjoins-convergence.md)     | Mirror Rails' second using_limitable_reflections? clause (joins ∪ left_outer_joins) across all three distinct-PK deferral sites | claimed | 120     | set-ops |
