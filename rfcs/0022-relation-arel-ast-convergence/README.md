...
| [apply-scope-qualified-where-predicate-builder-convergence](stories/apply-scope-qualified-where-predicate-builder-convergence.md) | Route AssociationScope#applyScope qualified WHERE through predicate builder (drop hand-derived bind)                            | claimed | 90      | —       |
