...
| [remove-tosql-connectionless-fallback](stories/remove-tosql-connectionless-fallback.md)                                 | Remove Relation#toSql connectionless fallback (resolve a connection like model.with_connection)                       | ready       | 80      | set-ops |
