...
| ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ------- | ------- | ------- |
| [audit-bind-inlining-rails-fidelity](stories/audit-bind-inlining-rails-fidelity.md)                                     | Audit: bind-inlining vs Rails — pin exact mechanism for compile/to_sql/where-clause                                   | ready   | 60      | verify  |
