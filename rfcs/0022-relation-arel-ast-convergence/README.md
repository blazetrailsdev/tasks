...
| [set-operations-eager-joindependency-composition](stories/set-operations-eager-joindependency-composition.md)               | Set-ops: compose eager-load operands as a JoinDependency-instantiated UNION (replace preload fallback)                | in-progress | 350     | set-ops |
