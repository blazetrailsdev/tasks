...
| [select-manager-as-alias-sqlliteral](stories/select-manager-as-alias-sqlliteral.md)                                         | SelectManager#as: model alias as SqlLiteral; drop TableAlias Grouping-shape heuristic                                 | claimed     | 80      | —       |
...
| [select-cte-body-bind-threading](stories/select-cte-body-bind-threading.md)                                                 | SELECT toSql: collect CTE-body binds through the visitor instead of inlining (buildCteSql)                            | in-progress | 200     | —       |
