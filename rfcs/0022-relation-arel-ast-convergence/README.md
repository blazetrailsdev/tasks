...
| [build-joins-emit-single-construct-join-dependency](stories/build-joins-emit-single-construct-join-dependency.md)                 | Converge emitJoinPlan to Rails' single construct_join_dependency(named_joins, join_type) shape                                  | in-progress | 120     | —       |
| [build-joins-seed-alias-tracker-leading-join-nodes](stories/build-joins-seed-alias-tracker-leading-join-nodes.md)                 | Seed build_joins AliasTracker with leading_joins + join_nodes (Rails alias_tracker)                                             | in-progress | 90      | —       |
