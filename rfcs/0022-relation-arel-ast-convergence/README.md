...
| --------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ------- | ------- | ------- |
| [eager-reflections-limitable-nested-hash-convergence](stories/eager-reflections-limitable-nested-hash-convergence.md)             | Converge \_eagerReflectionsAreLimitable to resolve nested-hash/array eager specs via JoinDependency reflections                 | claimed | 90      | —       |
