...
| [select-cte-body-bind-threading](stories/select-cte-body-bind-threading.md)                                                 | SELECT toSql: collect CTE-body binds through the visitor instead of inlining (buildCteSql)                            | claimed     | 200     | —       |
