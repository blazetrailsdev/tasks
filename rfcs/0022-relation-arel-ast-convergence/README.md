...
| [apply-scope-qualified-where-nested-hash-convergence](stories/apply-scope-qualified-where-nested-hash-convergence.md)             | Route AssociationScope#applyScope qualified WHERE fully through predicate-builder nested-hash (drop hand-built Arel node)       | in-progress | 120     | —       |
