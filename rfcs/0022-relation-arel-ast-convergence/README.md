...
| ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ----------- | ------- | ------- |
| [compile-arel-node-join-on-threading](stories/compile-arel-node-join-on-threading.md)                                   | Thread JOIN ON \_compileArelNode binds through outer collector (node-level alias rebinding)                           | draft       | 200     | set-ops |
