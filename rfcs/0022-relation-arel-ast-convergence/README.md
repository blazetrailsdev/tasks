...
| [whereclause-tosql-drop-inspectquoter](stories/whereclause-tosql-drop-inspectquoter.md)                                 | WhereClause#toSql: route through the connection (or remove) — drop bespoke inspectQuoter                              | claimed     | 90      | verify  |
