...
| [connection-tosql-via-collector](stories/connection-tosql-via-collector.md)                                             | connection.toSql compiles via collector() (drop the compileInlined regex)                                             | claimed | 120     | set-ops |
