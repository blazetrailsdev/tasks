...
assignee: null
blocked-by: null
closed-reason: "duplicate of port-application-env-config-for-action-dispatch-keys; its unique content_security_policy criteria were folded into the survivor in tasks #69; closed on RFC 0104's sunset"
---
