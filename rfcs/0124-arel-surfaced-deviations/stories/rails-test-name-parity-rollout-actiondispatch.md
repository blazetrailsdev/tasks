...
`actiondispatch` has 397 TS-only tests as of 2026-08-28, so it seeds to a real mark and then
burns down.

## Acceptance criteria

- `actiondispatch` is added to all four registrations, and its mark is seeded with
