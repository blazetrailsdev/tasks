---
title: "rails-test-name-parity-rollout-abstractcontroller"
status: draft
updated: 2026-08-28
...
`abstractcontroller` has 37 TS-only tests as of 2026-08-28, so it seeds to a real mark and then
burns down.

## Acceptance criteria

- `abstractcontroller` is added to all four registrations, and its mark is seeded with
