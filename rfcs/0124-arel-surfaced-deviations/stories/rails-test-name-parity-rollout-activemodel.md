---
title: "rails-test-name-parity-rollout-activemodel"
status: draft
updated: 2026-08-28
...
`activemodel` has 106 TS-only tests as of 2026-08-28, so it seeds to a real mark and then
burns down.

## Acceptance criteria

- `activemodel` is added to all four registrations, and its mark is seeded with
