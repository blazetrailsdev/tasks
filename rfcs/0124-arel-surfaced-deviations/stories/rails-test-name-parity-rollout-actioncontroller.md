---
title: "rails-test-name-parity-rollout-actioncontroller"
status: draft
updated: 2026-08-28
...
`actioncontroller` has 345 TS-only tests as of 2026-08-28, so it seeds to a real mark and then
burns down.

## Acceptance criteria

- `actioncontroller` is added to all four registrations, and its mark is seeded with
