...
This story ports **Lines 70-305: the low-level `Date._strptime` frags API — the directive table, width prefixes and the failure arms. Stops at `test_strptime` (`:306`).**
...
- `test__strptime__2`
- `test__strptime__3`
- `test__strptime__width`
- `test__strptime__fail`
