---
title: "Port test_switch_hitter.rb constructors + representation (10 tests)"
status: done
updated: 2026-08-10
...
This story ports \*\*Lines 7-299: constructors across all four spellings, the fractional-day seat, the `canon24oc` midnight fold, and the `#zone` / `#to_s` / `#inspect` / `#strftime` representation readers. Stops at `test_cmp` (`:300`).

`test_canon24oc` and the zone/offset readers directly exercise deviations already filed as merged C-read stories — this is where they get a gate.\*\*
