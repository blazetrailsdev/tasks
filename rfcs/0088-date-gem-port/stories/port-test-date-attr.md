---
title: "Port test_date_attr.rb (3 tests)"
status: in-progress
updated: 2026-08-10
...
priority: null
pr: 6312
claim: "2026-08-10T00:25:52Z"
assignee: "port-test-date-attr"
blocked-by: null
closed-reason: null
---
...
This story ports **The whole file (3 tests, ~110 lines). `test__attr` is broad — it walks every reader (`#year`, `#mon`, `#mday`, `#yday`, `#wday`, `#jd`, `#mjd`, `#ld`, `#ajd`, `#amjd`, the `cwyear`/`cweek`/`cwday` trio) across several seats.**

Ruby source: `vendor/date/test/date/test_date_attr.rb`
Target: `packages/date/src/test-date-attr.test.ts` (the convention name `test:compare` expects;
...
- `test__attr`
- `test__wday_predicate`
- `test_nth_kday`

## Acceptance criteria

- [ ] Every listed test is ported into `packages/date/src/test-date-attr.test.ts` under its Ruby
