...
- `packages/activerecord/src/persistence.test.ts` → mirror `vendor/rails/activerecord/test/cases/persistence_test.rb` (confirm it exists; if no 1:1 Rails file, the trails file is bespoke — delete it and port the Rails test cases that cover this behavior)
- `packages/activerecord/src/validations.test.ts` → mirror `vendor/rails/activerecord/test/cases/validations_test.rb` (confirm it exists; if no 1:1 Rails file, the trails file is bespoke — delete it and port the Rails test cases that cover this behavior)
- `packages/activerecord/src/autosave.test.ts` → mirror `vendor/rails/activerecord/test/cases/autosave_test.rb` (confirm it exists; if no 1:1 Rails file, the trails file is bespoke — delete it and port the Rails test cases that cover this behavior)
- `packages/activerecord/src/nested-attributes.test.ts` → mirror `vendor/rails/activerecord/test/cases/nested_attributes_test.rb` (confirm it exists; if no 1:1 Rails file, the trails file is bespoke — delete it and port the Rails test cases that cover this behavior)
