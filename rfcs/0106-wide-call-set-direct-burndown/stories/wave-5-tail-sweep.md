...
The whole remaining tail: every shard carrying **3 or fewer**
`kind: "set"` rows — 192 rows across 121 files as of 2026-08-21. This is the
last slice of RFC 0106; closing it meets the exit condition.

Much larger than one PR at the 700 LOC ceiling — ship it as sequential
non-overlapping PRs from `main`, never stacked. Regenerate the current list with
