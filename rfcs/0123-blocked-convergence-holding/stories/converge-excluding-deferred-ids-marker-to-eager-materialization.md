...
blocked-by: null
closed-reason: "Ratified: CLAUDE.md 'Relation is evaluated by an async query' already carries DeferredIdsIn/NotIn as PERMANENT and says not to file a story to remove them"
---
