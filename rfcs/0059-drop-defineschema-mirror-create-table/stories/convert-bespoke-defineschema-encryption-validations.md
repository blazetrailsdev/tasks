...
RFC 0059 (drop-defineschema-mirror-create-table). **Guiding principle: Rails fidelity above all else.** Phase 3 (depends on phase 1 loader) — encryption / validations bespoke conversions.
...
- `encryption/encryptable-record.test.ts`
