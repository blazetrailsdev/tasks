---
title: "Raise what Rails raises: the 8 missing-throw arms in activerecord's model and relation layers"
status: ready
updated: 2026-09-11
...
### The rows in this slice (8)

- `activerecord/attribute-assignment.ts#executeCallstackForMultiparameterAttributes`
- `activerecord/attribute-methods.ts#aliasAttributeMethodDefinition`
- `activerecord/encryption/encryptable-record.ts#preserveOriginalEncrypted`
- `activerecord/inheritance.ts#setBaseClass`
- `activerecord/relation/finder-methods.ts#findOne`
- `activerecord/relation/finder-methods.ts#findWithIds`
- `activerecord/relation/predicate-builder/relation-handler.ts#call`
- `activerecord/relation/query-methods.ts#buildJoinBuckets`
