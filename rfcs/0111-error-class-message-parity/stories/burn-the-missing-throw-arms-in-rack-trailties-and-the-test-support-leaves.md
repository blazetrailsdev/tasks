...
### The rows in this slice (5)

- `activerecord-test-support/connection.ts#connect`
- `rack/lint.ts#checkHeaders`
- `rack/response.ts#constructor`
- `rack/rewindable-input.ts#makeRewindable`
- `trailties/generators/rails/model/model-generator.ts#constructor`
