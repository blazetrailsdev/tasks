---
title: "Raise what Rails raises: the 8 missing-throw arms in actionview and the controller stack"
status: done
updated: 2026-09-11
...
- `abstractcontroller/url-for.ts#_routes`
- `actioncontroller/metal/mime-responds.ts#respondTo`
- `actioncontroller/metal/strong-parameters.ts#unpermittedParametersBang`
- `actioncontroller/test-case.ts#assignParameters`
- `actionview/base.ts#_run`
- `actionview/renderer/template-renderer.ts#determineTemplate`
- `actionview/renderer/template-renderer.ts#resolveLayout`
- `actionview/template.ts#compile`
