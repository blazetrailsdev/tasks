...
- `activemodel/secure-password.ts#hasSecurePassword`
- `activesupport/error-reporter.ts#ensureBacktrace`
- `activesupport/module-ext.ts#mattrReader`
- `activesupport/module-ext.ts#mattrWriter`
- `activesupport/module-ext.ts#rescueFrom`
- `activesupport/notifications/fanout.ts#subscribe`
- `activesupport/number-helper/number-to-human-converter.ts#unitExponents`
- `activesupport/time-with-zone.ts#change`
- `arel/visitors/visitor.ts#visit`
