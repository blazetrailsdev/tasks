...
| ----------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ------ | ------- | ------------------ |
| [commitandpush-mutator-exit-leaks-lock](stories/commitandpush-mutator-exit-leaks-lock.md)                                     | Mutator process.exit inside commitAndPush lock leaks the shared tasks lock                                       | ready  | 90      | —                  |
