...
| ----------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ------- | ------- | ------------------ |
| [guard-scaffold-template-byte-fidelity](stories/guard-scaffold-template-byte-fidelity.md)                                     | CI guard: scaffold generators stay byte-identical to 0000-template                                               | claimed | 90      | —                  |
