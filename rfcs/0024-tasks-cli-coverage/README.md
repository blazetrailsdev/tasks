...
| [hooks-install-independent-format-gate](stories/hooks-install-independent-format-gate.md)                                     | Make git hooks install-independent so the format gate fires in every worktree                         | ready   | 60      | guardrails         |
