...
| [tasks-cli-read-sync-discards-uncommitted-worktree-edits](stories/tasks-cli-read-sync-discards-uncommitted-worktree-edits.md) | tasks CLI read sync (reset --hard origin/main) silently discards uncommitted worktree edits                      | in-progress | 120     | —                  |
