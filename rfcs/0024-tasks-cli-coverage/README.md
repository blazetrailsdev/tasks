...
| ----------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ----------- | ------- | ------------------ |
| [guard-scaffold-template-byte-fidelity](stories/guard-scaffold-template-byte-fidelity.md)                                     | CI guard: scaffold generators stay byte-identical to 0000-template                                               | ready       | 90      | —                  |
| [ready-queue-gate-on-active-rfc](stories/ready-queue-gate-on-active-rfc.md)                                                   | ready() queue should exclude stories whose own RFC is not active                                                 | ready       | 60      | —                  |
| [set-deps-consume-shared-checkdepgraph](stories/set-deps-consume-shared-checkdepgraph.md)                                     | set-deps: consume shared checkDepGraph instead of restating the DFS                                              | ready       | 70      | —                  |
| [tasks-cli-read-sync-discards-uncommitted-worktree-edits](stories/tasks-cli-read-sync-discards-uncommitted-worktree-edits.md) | tasks CLI read sync (reset --hard origin/main) silently discards uncommitted worktree edits                      | ready       | 120     | —                  |
| [commitandpush-mutator-exit-leaks-lock](stories/commitandpush-mutator-exit-leaks-lock.md)                                     | Mutator process.exit inside commitAndPush lock leaks the shared tasks lock                                       | in-progress | 90      | —                  |
