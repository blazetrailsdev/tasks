...
| [set-deps-share-validator](stories/set-deps-share-validator.md)                                                               | set-deps: reuse validate-as-library's shared cycle/reference check                                    | claimed     | 40      | —                  |
| [storyfilepath-restore-generated](stories/storyfilepath-restore-generated.md)                                                 | storyFilePath: restore generated index files before error exit (matches rfcFilePath/priority pattern) | in-progress | 30      | —                  |
