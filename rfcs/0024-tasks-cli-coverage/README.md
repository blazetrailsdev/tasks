...
| ----------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ------- | ------- | ------------------ |
| [commitandpush-mutator-exit-leaks-lock](stories/commitandpush-mutator-exit-leaks-lock.md)                                     | Mutator process.exit inside commitAndPush lock leaks the shared tasks lock                                       | draft   | 90      | —                  |
| [guard-scaffold-template-byte-fidelity](stories/guard-scaffold-template-byte-fidelity.md)                                     | CI guard: scaffold generators stay byte-identical to 0000-template                                               | draft   | 90      | —                  |
| [ready-queue-gate-on-active-rfc](stories/ready-queue-gate-on-active-rfc.md)                                                   | ready() queue should exclude stories whose own RFC is not active                                                 | draft   | 60      | —                  |
| [set-deps-consume-shared-checkdepgraph](stories/set-deps-consume-shared-checkdepgraph.md)                                     | set-deps: consume shared checkDepGraph instead of restating the DFS                                              | draft   | 70      | —                  |
| [tasks-cli-read-sync-discards-uncommitted-worktree-edits](stories/tasks-cli-read-sync-discards-uncommitted-worktree-edits.md) | tasks CLI read sync (reset --hard origin/main) silently discards uncommitted worktree edits                      | draft   | 120     | —                  |
| [validate-story-body-quality](stories/validate-story-body-quality.md)                                                         | Validator: story body content gates (AC checkboxes, Context, Rails refs)                                         | claimed | 150     | guardrails         |
