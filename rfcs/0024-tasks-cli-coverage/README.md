...
| [ready-queue-gate-on-active-rfc](stories/ready-queue-gate-on-active-rfc.md)                                                   | ready() queue should exclude stories whose own RFC is not active                                                 | in-progress | 60      | —                  |
