...
| [cli-mutation-atomic-rollback-and-error-surfacing](stories/cli-mutation-atomic-rollback-and-error-surfacing.md)               | Mutation commands must be atomic (rollback partial write) and surface errors, not leave a blocked dirty checkout | claimed | 150     | guardrails         |
