...
| [auto-finalize-rebase-duplicate-rfc-dir](stories/auto-finalize-rebase-duplicate-rfc-dir.md)                                   | Finalize/rebase race leaves duplicate 0000-/NNNN- RFC dirs with orphaned stories                                 | ready       | 120     | guardrails         |
...
| [cli-mutation-atomic-rollback-and-error-surfacing](stories/cli-mutation-atomic-rollback-and-error-surfacing.md)               | Mutation commands must be atomic (rollback partial write) and surface errors, not leave a blocked dirty checkout | in-progress | 150     | guardrails         |
