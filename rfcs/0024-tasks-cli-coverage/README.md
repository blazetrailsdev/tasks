...
| [new-rfc-body-full-template-sections](stories/new-rfc-body-full-template-sections.md) | new-rfc scaffold body should match full 0000-template sections (Alternatives/Rollout/Open questions)  | claimed | 45      | rfc-commands       |
