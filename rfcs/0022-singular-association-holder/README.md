...
| [singular-reader-return-type-lie](stories/singular-reader-return-type-lie.md)                                               | singular reader return type lies — Promise cast silences TS                                                         | draft  | 40      | —            |
| [singular-reader-stale-target-check](stories/singular-reader-stale-target-check.md)                                         | singular-reader-stale-target-check                                                                                  | draft  | null    | —            |
