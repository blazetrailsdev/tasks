...
| [draft-ar-test-isolation-helper](rfcs/draft-ar-test-isolation-helper/README.md) | AR test harness — one isolation helper (useHandlerFixtures) + Rails config fidelity | draft | @dmarano | activerecord |
