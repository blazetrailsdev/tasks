...
|-----|-------|--------|-------|----------|
| [0000-branch-and-guard-parity](rfcs/0000-branch-and-guard-parity/README.md) | Branch and guard parity — the axis the call gates cannot see | draft | @deanmarano | activerecord, activemodel, activesupport, actionpack, actionview, arel, date, trailties |
