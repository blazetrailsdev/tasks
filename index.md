...
|-----|-------|--------|-------|----------|
| [0000-parity-skip-register-correctness](rfcs/0000-parity-skip-register-correctness/README.md) | Skip registers suppress ported surface instead of crediting it | draft | @deanmarano | activerecord, activesupport |
