#!/usr/bin/env node
// Validates rfcs repo content: frontmatter schemas, dep graph, ID
// uniqueness, cluster references, file-size cap. Exits non-zero with a
// human-readable report on any failure. Intended to run in CI and via
// the pre-commit hook.
import { loadAll, relPath, RFC_STATUSES, STORY_STATUSES } from "./lib.mjs";
